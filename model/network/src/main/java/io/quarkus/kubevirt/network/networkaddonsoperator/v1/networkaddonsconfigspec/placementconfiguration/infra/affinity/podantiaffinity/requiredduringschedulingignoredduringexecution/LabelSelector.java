package io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.placementconfiguration.infra.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution;
...
public class LabelSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.placementconfiguration.infra.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.labelselector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.placementconfiguration.infra.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.labelselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.placementconfiguration.infra.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.labelselector.MatchExpressions> matchExpressions) {
