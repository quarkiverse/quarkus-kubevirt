...
public class NetworkAddonsConfigStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigstatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(
            java.util.List<io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigstatus.Conditions> conditions) {
        this.conditions = conditions;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("containers")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigstatus.Containers> containers;

    public java.util.List<io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigstatus.Containers> getContainers() {
        return containers;
    }

    public void setContainers(
            java.util.List<io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigstatus.Containers> containers) {
