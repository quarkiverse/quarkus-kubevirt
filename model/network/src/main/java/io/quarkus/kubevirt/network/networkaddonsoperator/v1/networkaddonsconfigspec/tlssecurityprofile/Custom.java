package io.quarkus.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.tlssecurityprofile;
...
public class Custom implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    public enum Ciphers {
        ...
        ECDHEECDSAAES128SHA256("ECDHE-ECDSA-AES128-SHA256"),
        @com.fasterxml.jackson.annotation.JsonProperty("ECDHE-RSA-AES128-SHA256")
        ECDHERSAAES128SHA256("ECDHE-RSA-AES128-SHA256"),
        @com.fasterxml.jackson.annotation.JsonProperty("ECDHE-ECDSA-AES128-SHA")
        ECDHEECDSAAES128SHA("ECDHE-ECDSA-AES128-SHA"),
        @com.fasterxml.jackson.annotation.JsonProperty("ECDHE-RSA-AES128-SHA")
        ECDHERSAAES128SHA("ECDHE-RSA-AES128-SHA"),
        @com.fasterxml.jackson.annotation.JsonProperty("ECDHE-ECDSA-AES256-SHA384")
        ECDHEECDSAAES256SHA384("ECDHE-ECDSA-AES256-SHA384"),
        @com.fasterxml.jackson.annotation.JsonProperty("ECDHE-RSA-AES256-SHA384")
        ECDHERSAAES256SHA384("ECDHE-RSA-AES256-SHA384"),
        @com.fasterxml.jackson.annotation.JsonProperty("ECDHE-ECDSA-AES256-SHA")
        ECDHEECDSAAES256SHA("ECDHE-ECDSA-AES256-SHA"),
        @com.fasterxml.jackson.annotation.JsonProperty("ECDHE-RSA-AES256-SHA")
        ECDHERSAAES256SHA("ECDHE-RSA-AES256-SHA"),
        @com.fasterxml.jackson.annotation.JsonProperty("DHE-RSA-AES128-SHA256")
        DHERSAAES128SHA256("DHE-RSA-AES128-SHA256"),
        @com.fasterxml.jackson.annotation.JsonProperty("DHE-RSA-AES256-SHA256")
        DHERSAAES256SHA256("DHE-RSA-AES256-SHA256"),
        @com.fasterxml.jackson.annotation.JsonProperty("AES128-GCM-SHA256")
        AES128GCMSHA256("AES128-GCM-SHA256"),
        @com.fasterxml.jackson.annotation.JsonProperty("AES256-GCM-SHA384")
        AES256GCMSHA384("AES256-GCM-SHA384"),
        @com.fasterxml.jackson.annotation.JsonProperty("AES128-SHA256")
        AES128SHA256("AES128-SHA256"),
        @com.fasterxml.jackson.annotation.JsonProperty("AES256-SHA256")
        AES256SHA256("AES256-SHA256"),
        @com.fasterxml.jackson.annotation.JsonProperty("AES128-SHA")
        AES128SHA("AES128-SHA"),
        @com.fasterxml.jackson.annotation.JsonProperty("AES256-SHA")
        AES256SHA("AES256-SHA"),
        @com.fasterxml.jackson.annotation.JsonProperty("DES-CBC3-SHA")
    ...
    public enum MinTLSVersion {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("VersionTLS11")
        VERSIONTLS11("VersionTLS11"),
        @com.fasterxml.jackson.annotation.JsonProperty("VersionTLS12")
        VERSIONTLS12("VersionTLS12"),
        @com.fasterxml.jackson.annotation.JsonProperty("VersionTLS13")
