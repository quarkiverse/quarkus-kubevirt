...
public class NetworkAddonsConfigSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.KubeMacPool kubeMacPool;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.KubeMacPool getKubeMacPool() {
        return kubeMacPool;
    }

    public void setKubeMacPool(
            io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.KubeMacPool kubeMacPool) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.KubeSecondaryDNS kubeSecondaryDNS;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.KubeSecondaryDNS getKubeSecondaryDNS() {
        return kubeSecondaryDNS;
    }

    public void setKubeSecondaryDNS(
            io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.KubeSecondaryDNS kubeSecondaryDNS) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.LinuxBridge linuxBridge;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.LinuxBridge getLinuxBridge() {
        return linuxBridge;
    }

    public void setLinuxBridge(
            io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.LinuxBridge linuxBridge) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.Macvtap macvtap;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.Macvtap getMacvtap() {
        return macvtap;
    }

    public void setMacvtap(io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.Macvtap macvtap) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.Multus multus;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.Multus getMultus() {
        return multus;
    }

    public void setMultus(io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.Multus multus) {
        this.multus = multus;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.MultusDynamicNetworks multusDynamicNetworks;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.MultusDynamicNetworks getMultusDynamicNetworks() {
        return multusDynamicNetworks;
    }

    public void setMultusDynamicNetworks(
            io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.MultusDynamicNetworks multusDynamicNetworks) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.Ovs ovs;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.Ovs getOvs() {
        return ovs;
    }

    public void setOvs(io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.Ovs ovs) {
        this.ovs = ovs;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.PlacementConfiguration placementConfiguration;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.PlacementConfiguration getPlacementConfiguration() {
        return placementConfiguration;
    }

    public void setPlacementConfiguration(
            io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.PlacementConfiguration placementConfiguration) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.SelfSignConfiguration selfSignConfiguration;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.SelfSignConfiguration getSelfSignConfiguration() {
        return selfSignConfiguration;
    }

    public void setSelfSignConfiguration(
            io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.SelfSignConfiguration selfSignConfiguration) {
    ...
    private io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.TlsSecurityProfile tlsSecurityProfile;

    public io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.TlsSecurityProfile getTlsSecurityProfile() {
        return tlsSecurityProfile;
    }

    public void setTlsSecurityProfile(
            io.quarkiverse.kubevirt.network.networkaddonsoperator.v1.networkaddonsconfigspec.TlsSecurityProfile tlsSecurityProfile) {
