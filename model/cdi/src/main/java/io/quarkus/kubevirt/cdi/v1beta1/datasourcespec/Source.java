package io.quarkus.kubevirt.cdi.v1beta1.datasourcespec;
...
public class Source implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.cdi.v1beta1.datasourcespec.source.Pvc pvc;

    public io.quarkus.kubevirt.cdi.v1beta1.datasourcespec.source.Pvc getPvc() {
        return pvc;
    }

    public void setPvc(io.quarkus.kubevirt.cdi.v1beta1.datasourcespec.source.Pvc pvc) {
        this.pvc = pvc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.datasourcespec.source.Snapshot snapshot;

    public io.quarkus.kubevirt.cdi.v1beta1.datasourcespec.source.Snapshot getSnapshot() {
        return snapshot;
    }

    public void setSnapshot(io.quarkus.kubevirt.cdi.v1beta1.datasourcespec.source.Snapshot snapshot) {
