package io.quarkus.kubevirt.cdi.v1beta1.dataimportcronstatus;
...
public class Conditions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @io.fabric8.generator.annotation.Required()
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("DataImportCronConditionType is the string representation of known condition types")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private String type;
