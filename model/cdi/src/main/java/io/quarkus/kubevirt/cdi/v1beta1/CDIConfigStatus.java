...
public class CDIConfigStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigstatus.DefaultPodResourceRequirements defaultPodResourceRequirements;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigstatus.DefaultPodResourceRequirements getDefaultPodResourceRequirements() {
        return defaultPodResourceRequirements;
    }

    public void setDefaultPodResourceRequirements(
            io.quarkus.kubevirt.cdi.v1beta1.cdiconfigstatus.DefaultPodResourceRequirements defaultPodResourceRequirements) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigstatus.FilesystemOverhead filesystemOverhead;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigstatus.FilesystemOverhead getFilesystemOverhead() {
        return filesystemOverhead;
    }

    public void setFilesystemOverhead(io.quarkus.kubevirt.cdi.v1beta1.cdiconfigstatus.FilesystemOverhead filesystemOverhead) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigstatus.ImportProxy importProxy;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigstatus.ImportProxy getImportProxy() {
        return importProxy;
    }

    public void setImportProxy(io.quarkus.kubevirt.cdi.v1beta1.cdiconfigstatus.ImportProxy importProxy) {
