package io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec;
...
public class TlsSecurityProfile implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Custom custom;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Custom getCustom() {
        return custom;
    }

    public void setCustom(io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Custom custom) {
        this.custom = custom;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Intermediate intermediate;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Intermediate getIntermediate() {
        return intermediate;
    }

    public void setIntermediate(io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Intermediate intermediate) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Modern modern;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Modern getModern() {
        return modern;
    }

    public void setModern(io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Modern modern) {
        this.modern = modern;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Old old;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Old getOld() {
        return old;
    }

    public void setOld(io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.tlssecurityprofile.Old old) {
        this.old = old;
    }
