...
public class Workload implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.workload.Affinity affinity;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.workload.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(io.quarkus.kubevirt.cdi.v1beta1.cdispec.workload.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.cdi.v1beta1.cdispec.workload.Tolerations> tolerations;

    public java.util.List<io.quarkus.kubevirt.cdi.v1beta1.cdispec.workload.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(java.util.List<io.quarkus.kubevirt.cdi.v1beta1.cdispec.workload.Tolerations> tolerations) {
