...
public class ObjectTransferSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.objecttransferspec.Source source;

    public io.quarkus.kubevirt.cdi.v1beta1.objecttransferspec.Source getSource() {
        return source;
    }

    public void setSource(io.quarkus.kubevirt.cdi.v1beta1.objecttransferspec.Source source) {
        this.source = source;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.objecttransferspec.Target target;

    public io.quarkus.kubevirt.cdi.v1beta1.objecttransferspec.Target getTarget() {
        return target;
    }

    public void setTarget(io.quarkus.kubevirt.cdi.v1beta1.objecttransferspec.Target target) {
        this.target = target;
    }
}
