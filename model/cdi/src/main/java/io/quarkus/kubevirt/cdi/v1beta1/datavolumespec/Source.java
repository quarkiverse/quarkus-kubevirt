...
public class Source implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Blank blank;

    public io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Blank getBlank() {
        return blank;
    }

    public void setBlank(io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Blank blank) {
        this.blank = blank;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Http http;

    public io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Http getHttp() {
        return http;
    }

    public void setHttp(io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Http http) {
        this.http = http;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Imageio imageio;

    public io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Imageio getImageio() {
        return imageio;
    }

    public void setImageio(io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Imageio imageio) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Pvc pvc;

    public io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Pvc getPvc() {
        return pvc;
    }

    public void setPvc(io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Pvc pvc) {
        this.pvc = pvc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Registry registry;

    public io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Registry getRegistry() {
        return registry;
    }

    public void setRegistry(io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Registry registry) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.S3 s3;

    public io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.S3 getS3() {
        return s3;
    }

    public void setS3(io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.S3 s3) {
        this.s3 = s3;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Snapshot snapshot;

    public io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Snapshot getSnapshot() {
        return snapshot;
    }

    public void setSnapshot(io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Snapshot snapshot) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Upload upload;

    public io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Upload getUpload() {
        return upload;
    }

    public void setUpload(io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Upload upload) {
        this.upload = upload;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Vddk vddk;

    public io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Vddk getVddk() {
        return vddk;
    }

    public void setVddk(io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.source.Vddk vddk) {
        this.vddk = vddk;
    }
}
