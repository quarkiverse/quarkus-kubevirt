...
public class Config implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.FilesystemOverhead filesystemOverhead;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.FilesystemOverhead getFilesystemOverhead() {
        return filesystemOverhead;
    }

    public void setFilesystemOverhead(io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.FilesystemOverhead filesystemOverhead) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.ImportProxy importProxy;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.ImportProxy getImportProxy() {
        return importProxy;
    }

    public void setImportProxy(io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.ImportProxy importProxy) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.PodResourceRequirements podResourceRequirements;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.PodResourceRequirements getPodResourceRequirements() {
        return podResourceRequirements;
    }

    public void setPodResourceRequirements(
            io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.PodResourceRequirements podResourceRequirements) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.TlsSecurityProfile tlsSecurityProfile;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.TlsSecurityProfile getTlsSecurityProfile() {
        return tlsSecurityProfile;
    }

    public void setTlsSecurityProfile(io.quarkus.kubevirt.cdi.v1beta1.cdispec.config.TlsSecurityProfile tlsSecurityProfile) {
