...
public class CDISpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.CertConfig certConfig;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.CertConfig getCertConfig() {
        return certConfig;
    }

    public void setCertConfig(io.quarkus.kubevirt.cdi.v1beta1.cdispec.CertConfig certConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.Config config;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.Config getConfig() {
        return config;
    }

    public void setConfig(io.quarkus.kubevirt.cdi.v1beta1.cdispec.Config config) {
        this.config = config;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.Infra infra;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.Infra getInfra() {
        return infra;
    }

    public void setInfra(io.quarkus.kubevirt.cdi.v1beta1.cdispec.Infra infra) {
        this.infra = infra;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.Workload workload;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.Workload getWorkload() {
        return workload;
    }

    public void setWorkload(io.quarkus.kubevirt.cdi.v1beta1.cdispec.Workload workload) {
