...
public class Storage implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.DataSource dataSource;

    public io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.DataSource dataSource) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.DataSourceRef dataSourceRef;

    public io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.DataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(
            io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.DataSourceRef dataSourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.Resources resources;

    public io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.Resources getResources() {
        return resources;
    }

    public void setResources(io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.Selector selector;

    public io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.Selector getSelector() {
        return selector;
    }

    public void setSelector(io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.storage.Selector selector) {
