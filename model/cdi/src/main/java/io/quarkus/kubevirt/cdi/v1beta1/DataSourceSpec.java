...
public class DataSourceSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.cdi.v1beta1.datasourcespec.Source source;

    public io.quarkus.kubevirt.cdi.v1beta1.datasourcespec.Source getSource() {
        return source;
    }

    public void setSource(io.quarkus.kubevirt.cdi.v1beta1.datasourcespec.Source source) {
        this.source = source;
    }
}
