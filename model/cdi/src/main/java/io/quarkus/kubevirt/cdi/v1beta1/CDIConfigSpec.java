...
public class CDIConfigSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.FilesystemOverhead filesystemOverhead;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.FilesystemOverhead getFilesystemOverhead() {
        return filesystemOverhead;
    }

    public void setFilesystemOverhead(io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.FilesystemOverhead filesystemOverhead) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.ImportProxy importProxy;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.ImportProxy getImportProxy() {
        return importProxy;
    }

    public void setImportProxy(io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.ImportProxy importProxy) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.PodResourceRequirements podResourceRequirements;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.PodResourceRequirements getPodResourceRequirements() {
        return podResourceRequirements;
    }

    public void setPodResourceRequirements(
            io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.PodResourceRequirements podResourceRequirements) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.TlsSecurityProfile tlsSecurityProfile;

    public io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.TlsSecurityProfile getTlsSecurityProfile() {
        return tlsSecurityProfile;
    }

    public void setTlsSecurityProfile(io.quarkus.kubevirt.cdi.v1beta1.cdiconfigspec.TlsSecurityProfile tlsSecurityProfile) {
