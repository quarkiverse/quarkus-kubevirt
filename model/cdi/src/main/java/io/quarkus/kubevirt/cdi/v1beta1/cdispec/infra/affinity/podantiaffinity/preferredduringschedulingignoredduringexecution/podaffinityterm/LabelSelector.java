...
public class LabelSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.cdi.v1beta1.cdispec.infra.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.labelselector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkus.kubevirt.cdi.v1beta1.cdispec.infra.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.labelselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkus.kubevirt.cdi.v1beta1.cdispec.infra.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.labelselector.MatchExpressions> matchExpressions) {
