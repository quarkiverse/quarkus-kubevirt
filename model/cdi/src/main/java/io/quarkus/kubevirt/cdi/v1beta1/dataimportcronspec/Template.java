package io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec;
...
public class Template implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.Metadata metadata;

    public io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.Metadata metadata) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.Spec spec;

    public io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.Spec getSpec() {
        return spec;
    }

    public void setSpec(io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.Spec spec) {
        this.spec = spec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.Status status;

    public io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.Status getStatus() {
        return status;
    }

    public void setStatus(io.quarkus.kubevirt.cdi.v1beta1.dataimportcronspec.template.Status status) {
        this.status = status;
    }
}
