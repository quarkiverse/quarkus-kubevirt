...
public class Infra implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.cdi.v1beta1.cdispec.infra.Affinity affinity;

    public io.quarkus.kubevirt.cdi.v1beta1.cdispec.infra.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(io.quarkus.kubevirt.cdi.v1beta1.cdispec.infra.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.cdi.v1beta1.cdispec.infra.Tolerations> tolerations;

    public java.util.List<io.quarkus.kubevirt.cdi.v1beta1.cdispec.infra.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(java.util.List<io.quarkus.kubevirt.cdi.v1beta1.cdispec.infra.Tolerations> tolerations) {
