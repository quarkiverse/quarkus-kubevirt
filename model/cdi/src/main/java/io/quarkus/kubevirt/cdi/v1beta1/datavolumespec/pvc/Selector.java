package io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.pvc;
...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.pvc.selector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.pvc.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkus.kubevirt.cdi.v1beta1.datavolumespec.pvc.selector.MatchExpressions> matchExpressions) {
