...
public class StorageProfileStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.cdi.v1beta1.storageprofilestatus.ClaimPropertySets> claimPropertySets;

    public java.util.List<io.quarkus.kubevirt.cdi.v1beta1.storageprofilestatus.ClaimPropertySets> getClaimPropertySets() {
        return claimPropertySets;
    }

    public void setClaimPropertySets(
            java.util.List<io.quarkus.kubevirt.cdi.v1beta1.storageprofilestatus.ClaimPropertySets> claimPropertySets) {
