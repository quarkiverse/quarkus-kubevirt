...
public class DataVolumeSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Checkpoints> checkpoints;

  public java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Checkpoints> getCheckpoints() {
    return checkpoints;
  }

  public void setCheckpoints(java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Checkpoints> checkpoints) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Pvc pvc;

  public io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Pvc getPvc() {
    return pvc;
  }

  public void setPvc(io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Pvc pvc) {
    this.pvc = pvc;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Source source;

  public io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Source getSource() {
    return source;
  }

  public void setSource(io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Source source) {
    this.source = source;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.SourceRef sourceRef;

  public io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.SourceRef getSourceRef() {
    return sourceRef;
  }

  public void setSourceRef(io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.SourceRef sourceRef) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Storage storage;

  public io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Storage getStorage() {
    return storage;
  }

  public void setStorage(io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.Storage storage) {
