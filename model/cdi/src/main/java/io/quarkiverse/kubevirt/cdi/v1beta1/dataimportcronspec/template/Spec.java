package io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Checkpoints> checkpoints;

  public java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Checkpoints> getCheckpoints() {
    return checkpoints;
  }

  public void setCheckpoints(
      java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Checkpoints> checkpoints) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Pvc pvc;

  public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Pvc getPvc() {
    return pvc;
  }

  public void setPvc(io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Pvc pvc) {
    this.pvc = pvc;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Source source;

  public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Source getSource() {
    return source;
  }

  public void setSource(io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Source source) {
    this.source = source;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.SourceRef sourceRef;

  public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.SourceRef getSourceRef() {
    return sourceRef;
  }

  public void setSourceRef(io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.SourceRef sourceRef) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Storage storage;

  public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Storage getStorage() {
    return storage;
  }

  public void setStorage(io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.Storage storage) {
