...
public class Pvc implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.DataSource dataSource;

    public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.DataSource dataSource) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.DataSourceRef dataSourceRef;

    public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.DataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(
            io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.DataSourceRef dataSourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.Resources resources;

    public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.Resources getResources() {
        return resources;
    }

    public void setResources(io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.Selector selector;

    public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.Selector getSelector() {
        return selector;
    }

    public void setSelector(io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.template.spec.pvc.Selector selector) {
