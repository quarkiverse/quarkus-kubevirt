package io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.storage;
...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.storage.selector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.storage.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.datavolumespec.storage.selector.MatchExpressions> matchExpressions) {
