...
public class CertConfig implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.cdi.v1beta1.cdispec.certconfig.Ca ca;

    public io.quarkiverse.kubevirt.cdi.v1beta1.cdispec.certconfig.Ca getCa() {
        return ca;
    }

    public void setCa(io.quarkiverse.kubevirt.cdi.v1beta1.cdispec.certconfig.Ca ca) {
        this.ca = ca;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.cdi.v1beta1.cdispec.certconfig.Server server;

    public io.quarkiverse.kubevirt.cdi.v1beta1.cdispec.certconfig.Server getServer() {
        return server;
    }

    public void setServer(io.quarkiverse.kubevirt.cdi.v1beta1.cdispec.certconfig.Server server) {
        this.server = server;
    }
}
