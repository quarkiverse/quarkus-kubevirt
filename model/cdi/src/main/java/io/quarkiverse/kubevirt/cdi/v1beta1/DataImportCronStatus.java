...
public class DataImportCronStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronstatus.Conditions> conditions;

  public java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronstatus.Conditions> getConditions() {
    return conditions;
  }

  public void setConditions(java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronstatus.Conditions> conditions) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronstatus.CurrentImports> currentImports;

  public java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronstatus.CurrentImports> getCurrentImports() {
    return currentImports;
  }

  public void setCurrentImports(
      java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronstatus.CurrentImports> currentImports) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronstatus.LastImportedPVC lastImportedPVC;

  public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronstatus.LastImportedPVC getLastImportedPVC() {
    return lastImportedPVC;
  }

  public void setLastImportedPVC(io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronstatus.LastImportedPVC lastImportedPVC) {
