package io.quarkiverse.kubevirt.cdi.v1beta1.objecttransferstatus;
...
public class Conditions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @io.fabric8.generator.annotation.Required()
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("ObjectTransferConditionType is the type of ObjectTransferCondition")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private String type;
