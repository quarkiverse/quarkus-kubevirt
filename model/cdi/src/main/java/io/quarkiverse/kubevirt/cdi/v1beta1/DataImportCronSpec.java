...
public class DataImportCronSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.Template template;

    public io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.Template getTemplate() {
        return template;
    }

    public void setTemplate(io.quarkiverse.kubevirt.cdi.v1beta1.dataimportcronspec.Template template) {
