...
public class CDIStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.cdistatus.Conditions> conditions;

  public java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.cdistatus.Conditions> getConditions() {
    return conditions;
  }

  public void setConditions(java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.cdistatus.Conditions> conditions) {
