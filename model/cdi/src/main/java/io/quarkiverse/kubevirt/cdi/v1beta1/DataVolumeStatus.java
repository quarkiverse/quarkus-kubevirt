...
public class DataVolumeStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.datavolumestatus.Conditions> conditions;

  public java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.datavolumestatus.Conditions> getConditions() {
    return conditions;
  }

  public void setConditions(java.util.List<io.quarkiverse.kubevirt.cdi.v1beta1.datavolumestatus.Conditions> conditions) {
