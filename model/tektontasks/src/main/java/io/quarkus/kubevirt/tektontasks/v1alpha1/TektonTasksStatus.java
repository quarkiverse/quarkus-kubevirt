...
public class TektonTasksStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.tektontasks.v1alpha1.tektontasksstatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.tektontasks.v1alpha1.tektontasksstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(
            java.util.List<io.quarkus.kubevirt.tektontasks.v1alpha1.tektontasksstatus.Conditions> conditions) {
