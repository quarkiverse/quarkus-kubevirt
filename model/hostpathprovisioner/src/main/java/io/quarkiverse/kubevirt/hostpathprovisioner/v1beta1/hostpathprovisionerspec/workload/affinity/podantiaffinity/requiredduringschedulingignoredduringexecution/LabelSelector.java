...
public class LabelSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.workload.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.labelselector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.workload.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.labelselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.workload.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.labelselector.MatchExpressions> matchExpressions) {
