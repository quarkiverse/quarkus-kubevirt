...
public class HostPathProvisionerSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.PathConfig pathConfig;

    public io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.PathConfig getPathConfig() {
        return pathConfig;
    }

    public void setPathConfig(io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.PathConfig pathConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.StoragePools> storagePools;

    public java.util.List<io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.StoragePools> getStoragePools() {
        return storagePools;
    }

    public void setStoragePools(
            java.util.List<io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.StoragePools> storagePools) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.Workload workload;

    public io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.Workload getWorkload() {
        return workload;
    }

    public void setWorkload(io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.Workload workload) {
