package io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.storagepoolstatuses.claimstatuses.status;
...
public class Conditions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    /**
     * reason is a unique, this should be a short, machine understandable string that gives the reason for condition's last
