...
@TemplateTransformations(annotations = @AnnotationSelector(io.fabric8.kubernetes.model.annotation.Group.class), value = {
        ...
        @TemplateTransformation(value = "/dsl.vm", outputPath = "io.quarkiverse.kubevirt/hostpathprovisioner/v1beta1/Dsl.java", gather = true),
        @TemplateTransformation(value = "/client.vm", outputPath = "io.quarkiverse.kubevirt/hostpathprovisioner/v1beta1/Client.java", gather = true)
})
