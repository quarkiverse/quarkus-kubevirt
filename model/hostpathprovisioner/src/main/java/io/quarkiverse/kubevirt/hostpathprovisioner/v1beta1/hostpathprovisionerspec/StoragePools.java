...
public class StoragePools implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.PvcTemplate pvcTemplate;

    public io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.PvcTemplate getPvcTemplate() {
        return pvcTemplate;
    }

    public void setPvcTemplate(
            io.quarkiverse.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.PvcTemplate pvcTemplate) {
