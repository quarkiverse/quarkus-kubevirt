package io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools;
...
public class PvcTemplate implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.DataSource dataSource;

    public io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(
            io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.DataSource dataSource) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.DataSourceRef dataSourceRef;

    public io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.DataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(
            io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.DataSourceRef dataSourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.Resources resources;

    public io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.Resources getResources() {
        return resources;
    }

    public void setResources(
            io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.Selector selector;

    public io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.Selector getSelector() {
        return selector;
    }

    public void setSelector(
            io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.Selector selector) {
