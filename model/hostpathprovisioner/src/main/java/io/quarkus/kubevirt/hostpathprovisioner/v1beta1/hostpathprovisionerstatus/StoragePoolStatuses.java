...
public class StoragePoolStatuses implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.storagepoolstatuses.ClaimStatuses> claimStatuses;

    public java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.storagepoolstatuses.ClaimStatuses> getClaimStatuses() {
        return claimStatuses;
    }

    public void setClaimStatuses(
            java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.storagepoolstatuses.ClaimStatuses> claimStatuses) {
