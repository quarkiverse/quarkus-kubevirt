...
public class HostPathProvisionerStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(
            java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.Conditions> conditions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.StoragePoolStatuses> storagePoolStatuses;

    public java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.StoragePoolStatuses> getStoragePoolStatuses() {
        return storagePoolStatuses;
    }

    public void setStoragePoolStatuses(
            java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerstatus.StoragePoolStatuses> storagePoolStatuses) {
