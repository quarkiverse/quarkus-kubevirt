package io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate;
...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.selector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.selector.MatchExpressions> matchExpressions) {
