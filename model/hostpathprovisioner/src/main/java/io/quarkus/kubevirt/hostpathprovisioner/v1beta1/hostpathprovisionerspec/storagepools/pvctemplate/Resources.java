...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.resources.Claims> claims;

    public java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(
            java.util.List<io.quarkus.kubevirt.hostpathprovisioner.v1beta1.hostpathprovisionerspec.storagepools.pvctemplate.resources.Claims> claims) {
        this.claims = claims;
    }
