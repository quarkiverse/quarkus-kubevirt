...
public class Infra implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.infra.NodePlacement nodePlacement;

    public io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.infra.NodePlacement getNodePlacement() {
        return nodePlacement;
    }

    public void setNodePlacement(io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.infra.NodePlacement nodePlacement) {
