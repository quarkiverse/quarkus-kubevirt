package io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions;
...
public class Disk implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.BlockSize blockSize;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.BlockSize getBlockSize() {
        return blockSize;
    }

    public void setBlockSize(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.BlockSize blockSize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.Cdrom cdrom;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.Cdrom getCdrom() {
        return cdrom;
    }

    public void setCdrom(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.Cdrom cdrom) {
        this.cdrom = cdrom;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.Disk disk;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.Disk getDisk() {
        return disk;
    }

    public void setDisk(io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.Disk disk) {
        this.disk = disk;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.Lun lun;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.Lun getLun() {
        return lun;
    }

    public void setLun(io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.disk.Lun lun) {
        this.lun = lun;
    }
