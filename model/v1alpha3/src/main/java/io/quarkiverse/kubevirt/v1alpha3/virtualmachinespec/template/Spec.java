package io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.AccessCredentials> accessCredentials;

  public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.AccessCredentials> getAccessCredentials() {
    return accessCredentials;
  }

  public void setAccessCredentials(
      java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.AccessCredentials> accessCredentials) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Affinity affinity;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Affinity getAffinity() {
    return affinity;
  }

  public void setAffinity(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Affinity affinity) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.DnsConfig dnsConfig;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.DnsConfig getDnsConfig() {
    return dnsConfig;
  }

  public void setDnsConfig(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.DnsConfig dnsConfig) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Domain domain;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Domain getDomain() {
    return domain;
  }

  public void setDomain(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Domain domain) {
    this.domain = domain;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.LivenessProbe livenessProbe;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.LivenessProbe getLivenessProbe() {
    return livenessProbe;
  }

  public void setLivenessProbe(
      io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.LivenessProbe livenessProbe) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Networks> networks;

  public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Networks> getNetworks() {
    return networks;
  }

  public void setNetworks(
      java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Networks> networks) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.ReadinessProbe readinessProbe;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.ReadinessProbe getReadinessProbe() {
    return readinessProbe;
  }

  public void setReadinessProbe(
      io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.ReadinessProbe readinessProbe) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Tolerations> tolerations;

  public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Tolerations> getTolerations() {
    return tolerations;
  }

  public void setTolerations(
      java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Tolerations> tolerations) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.TopologySpreadConstraints> topologySpreadConstraints;

  public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.TopologySpreadConstraints> getTopologySpreadConstraints() {
    return topologySpreadConstraints;
  }

  public void setTopologySpreadConstraints(
      java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.TopologySpreadConstraints> topologySpreadConstraints) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Volumes> volumes;

  public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Volumes> getVolumes() {
    return volumes;
  }

  public void setVolumes(java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.Volumes> volumes) {
