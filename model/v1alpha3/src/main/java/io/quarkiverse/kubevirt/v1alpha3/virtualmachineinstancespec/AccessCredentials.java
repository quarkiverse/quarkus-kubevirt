...
public class AccessCredentials implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.SshPublicKey sshPublicKey;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.SshPublicKey getSshPublicKey() {
        return sshPublicKey;
    }

    public void setSshPublicKey(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.SshPublicKey sshPublicKey) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.UserPassword userPassword;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.UserPassword getUserPassword() {
        return userPassword;
    }

    public void setUserPassword(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.UserPassword userPassword) {
