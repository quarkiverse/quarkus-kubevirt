...
public class AccessCredentials implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.SshPublicKey sshPublicKey;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.SshPublicKey getSshPublicKey() {
        return sshPublicKey;
    }

    public void setSshPublicKey(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.SshPublicKey sshPublicKey) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.UserPassword userPassword;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.UserPassword getUserPassword() {
        return userPassword;
    }

    public void setUserPassword(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.UserPassword userPassword) {
