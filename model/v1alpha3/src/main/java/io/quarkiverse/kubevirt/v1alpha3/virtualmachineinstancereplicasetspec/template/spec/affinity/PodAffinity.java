...
public class PodAffinity implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podaffinity.PreferredDuringSchedulingIgnoredDuringExecution> preferredDuringSchedulingIgnoredDuringExecution;

  public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podaffinity.PreferredDuringSchedulingIgnoredDuringExecution> getPreferredDuringSchedulingIgnoredDuringExecution() {
    return preferredDuringSchedulingIgnoredDuringExecution;
  }

  public void setPreferredDuringSchedulingIgnoredDuringExecution(
      java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podaffinity.PreferredDuringSchedulingIgnoredDuringExecution> preferredDuringSchedulingIgnoredDuringExecution) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podaffinity.RequiredDuringSchedulingIgnoredDuringExecution> requiredDuringSchedulingIgnoredDuringExecution;

  public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podaffinity.RequiredDuringSchedulingIgnoredDuringExecution> getRequiredDuringSchedulingIgnoredDuringExecution() {
    return requiredDuringSchedulingIgnoredDuringExecution;
  }

  public void setRequiredDuringSchedulingIgnoredDuringExecution(
      java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podaffinity.RequiredDuringSchedulingIgnoredDuringExecution> requiredDuringSchedulingIgnoredDuringExecution) {
