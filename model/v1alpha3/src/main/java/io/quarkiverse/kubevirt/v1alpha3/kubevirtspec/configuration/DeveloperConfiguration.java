...
public class DeveloperConfiguration implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.developerconfiguration.DiskVerification diskVerification;

  public io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.developerconfiguration.DiskVerification getDiskVerification() {
    return diskVerification;
  }

  public void setDiskVerification(
      io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.developerconfiguration.DiskVerification diskVerification) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.developerconfiguration.LogVerbosity logVerbosity;

  public io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.developerconfiguration.LogVerbosity getLogVerbosity() {
    return logVerbosity;
  }

  public void setLogVerbosity(
      io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.developerconfiguration.LogVerbosity logVerbosity) {
