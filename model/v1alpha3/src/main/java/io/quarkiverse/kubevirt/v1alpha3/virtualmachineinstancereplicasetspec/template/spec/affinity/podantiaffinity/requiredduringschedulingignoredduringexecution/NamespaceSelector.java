package io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution;
...
public class NamespaceSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.namespaceselector.MatchExpressions> matchExpressions;

  public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.namespaceselector.MatchExpressions> getMatchExpressions() {
    return matchExpressions;
  }

  public void setMatchExpressions(
      java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.namespaceselector.MatchExpressions> matchExpressions) {
