...
public class Networks implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Multus multus;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Multus getMultus() {
        return multus;
    }

    public void setMultus(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Multus multus) {
        this.multus = multus;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Pod pod;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Pod getPod() {
        return pod;
    }

    public void setPod(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Pod pod) {
        this.pod = pod;
    }
}
