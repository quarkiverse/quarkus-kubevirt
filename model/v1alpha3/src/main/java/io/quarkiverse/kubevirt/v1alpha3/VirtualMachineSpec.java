...
public class VirtualMachineSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.DataVolumeTemplates> dataVolumeTemplates;

    public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.DataVolumeTemplates> getDataVolumeTemplates() {
        return dataVolumeTemplates;
    }

    public void setDataVolumeTemplates(
            java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.DataVolumeTemplates> dataVolumeTemplates) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.Instancetype instancetype;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.Instancetype getInstancetype() {
        return instancetype;
    }

    public void setInstancetype(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.Instancetype instancetype) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.Preference preference;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.Preference getPreference() {
        return preference;
    }

    public void setPreference(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.Preference preference) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.Template template;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.Template getTemplate() {
        return template;
    }

    public void setTemplate(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.Template template) {
