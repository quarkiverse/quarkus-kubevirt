...
public class MigrationState implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.migrationstate.MigrationConfiguration migrationConfiguration;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.migrationstate.MigrationConfiguration getMigrationConfiguration() {
        return migrationConfiguration;
    }

    public void setMigrationConfiguration(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.migrationstate.MigrationConfiguration migrationConfiguration) {
