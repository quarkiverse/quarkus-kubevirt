package io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Checkpoints> checkpoints;

  public java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Checkpoints> getCheckpoints() {
    return checkpoints;
  }

  public void setCheckpoints(
      java.util.List<io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Checkpoints> checkpoints) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Pvc pvc;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Pvc getPvc() {
    return pvc;
  }

  public void setPvc(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Pvc pvc) {
    this.pvc = pvc;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Source source;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Source getSource() {
    return source;
  }

  public void setSource(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Source source) {
    this.source = source;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.SourceRef sourceRef;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.SourceRef getSourceRef() {
    return sourceRef;
  }

  public void setSourceRef(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.SourceRef sourceRef) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Storage storage;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Storage getStorage() {
    return storage;
  }

  public void setStorage(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.Storage storage) {
