...
public class VirtualMachineInstanceReplicaSetSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.Selector selector;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.Selector getSelector() {
    return selector;
  }

  public void setSelector(io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.Selector selector) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.Template template;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.Template getTemplate() {
    return template;
  }

  public void setTemplate(io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.Template template) {
