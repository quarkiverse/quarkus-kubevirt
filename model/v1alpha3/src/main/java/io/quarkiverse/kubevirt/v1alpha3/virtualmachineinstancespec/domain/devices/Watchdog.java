...
public class Watchdog implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancespec.domain.devices.watchdog.I6300esb i6300esb;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancespec.domain.devices.watchdog.I6300esb getI6300esb() {
    return i6300esb;
  }

  public void setI6300esb(
      io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancespec.domain.devices.watchdog.I6300esb i6300esb) {
