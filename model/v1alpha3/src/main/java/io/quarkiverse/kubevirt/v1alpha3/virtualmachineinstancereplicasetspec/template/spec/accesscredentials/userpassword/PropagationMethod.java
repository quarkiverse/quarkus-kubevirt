package io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.userpassword;
...
public class PropagationMethod implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.userpassword.propagationmethod.QemuGuestAgent qemuGuestAgent;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.userpassword.propagationmethod.QemuGuestAgent getQemuGuestAgent() {
        return qemuGuestAgent;
    }

    public void setQemuGuestAgent(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.userpassword.propagationmethod.QemuGuestAgent qemuGuestAgent) {
