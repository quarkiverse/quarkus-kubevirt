...
public class KernelBoot implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.firmware.kernelboot.Container container;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.firmware.kernelboot.Container getContainer() {
    return container;
  }

  public void setContainer(
      io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.firmware.kernelboot.Container container) {
