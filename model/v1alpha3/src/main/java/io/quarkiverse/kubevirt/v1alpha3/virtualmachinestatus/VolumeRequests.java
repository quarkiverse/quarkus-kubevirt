package io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus;
...
public class VolumeRequests implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.AddVolumeOptions addVolumeOptions;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.AddVolumeOptions getAddVolumeOptions() {
        return addVolumeOptions;
    }

    public void setAddVolumeOptions(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.AddVolumeOptions addVolumeOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.RemoveVolumeOptions removeVolumeOptions;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.RemoveVolumeOptions getRemoveVolumeOptions() {
        return removeVolumeOptions;
    }

    public void setRemoveVolumeOptions(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.RemoveVolumeOptions removeVolumeOptions) {
