...
public class VolumeStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.HotplugVolume hotplugVolume;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.HotplugVolume getHotplugVolume() {
        return hotplugVolume;
    }

    public void setHotplugVolume(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.HotplugVolume hotplugVolume) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.MemoryDumpVolume memoryDumpVolume;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.MemoryDumpVolume getMemoryDumpVolume() {
        return memoryDumpVolume;
    }

    public void setMemoryDumpVolume(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.MemoryDumpVolume memoryDumpVolume) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.PersistentVolumeClaimInfo persistentVolumeClaimInfo;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.PersistentVolumeClaimInfo getPersistentVolumeClaimInfo() {
        return persistentVolumeClaimInfo;
    }

    public void setPersistentVolumeClaimInfo(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.PersistentVolumeClaimInfo persistentVolumeClaimInfo) {
