...
public class Ephemeral implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.volumes.ephemeral.PersistentVolumeClaim persistentVolumeClaim;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.volumes.ephemeral.PersistentVolumeClaim getPersistentVolumeClaim() {
        return persistentVolumeClaim;
    }

    public void setPersistentVolumeClaim(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.volumes.ephemeral.PersistentVolumeClaim persistentVolumeClaim) {
