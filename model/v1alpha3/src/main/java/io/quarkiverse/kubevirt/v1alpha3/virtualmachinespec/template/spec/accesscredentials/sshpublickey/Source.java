...
public class Source implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.accesscredentials.sshpublickey.source.Secret secret;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.accesscredentials.sshpublickey.source.Secret getSecret() {
        return secret;
    }

    public void setSecret(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.accesscredentials.sshpublickey.source.Secret secret) {
        this.secret = secret;
    }
}
