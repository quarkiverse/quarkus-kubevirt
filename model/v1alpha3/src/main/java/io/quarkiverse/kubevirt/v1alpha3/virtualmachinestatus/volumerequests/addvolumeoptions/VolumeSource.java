...
public class VolumeSource implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.volumesource.DataVolume dataVolume;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.volumesource.DataVolume getDataVolume() {
        return dataVolume;
    }

    public void setDataVolume(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.volumesource.DataVolume dataVolume) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.volumesource.PersistentVolumeClaim persistentVolumeClaim;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.volumesource.PersistentVolumeClaim getPersistentVolumeClaim() {
        return persistentVolumeClaim;
    }

    public void setPersistentVolumeClaim(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachinestatus.volumerequests.addvolumeoptions.volumesource.PersistentVolumeClaim persistentVolumeClaim) {
