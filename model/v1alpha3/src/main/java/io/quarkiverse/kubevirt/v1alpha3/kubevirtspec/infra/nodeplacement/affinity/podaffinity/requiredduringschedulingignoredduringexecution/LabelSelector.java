...
public class LabelSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.infra.nodeplacement.affinity.podaffinity.requiredduringschedulingignoredduringexecution.labelselector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.infra.nodeplacement.affinity.podaffinity.requiredduringschedulingignoredduringexecution.labelselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.infra.nodeplacement.affinity.podaffinity.requiredduringschedulingignoredduringexecution.labelselector.MatchExpressions> matchExpressions) {
