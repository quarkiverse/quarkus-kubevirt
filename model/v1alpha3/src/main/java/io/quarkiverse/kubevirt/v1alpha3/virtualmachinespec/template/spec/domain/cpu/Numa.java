package io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.domain.cpu;
...
public class Numa implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.domain.cpu.numa.GuestMappingPassthrough guestMappingPassthrough;

  public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.domain.cpu.numa.GuestMappingPassthrough getGuestMappingPassthrough() {
    return guestMappingPassthrough;
  }

  public void setGuestMappingPassthrough(
      io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.domain.cpu.numa.GuestMappingPassthrough guestMappingPassthrough) {
