...
public class LaunchSecurity implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.domain.launchsecurity.Sev sev;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.domain.launchsecurity.Sev getSev() {
        return sev;
    }

    public void setSev(io.quarkiverse.kubevirt.v1alpha3.virtualmachinespec.template.spec.domain.launchsecurity.Sev sev) {
        this.sev = sev;
    }
}
