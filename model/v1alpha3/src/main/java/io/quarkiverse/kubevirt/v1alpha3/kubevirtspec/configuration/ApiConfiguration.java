...
public class ApiConfiguration implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.apiconfiguration.RestClient restClient;

  public io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.apiconfiguration.RestClient getRestClient() {
    return restClient;
  }

  public void setRestClient(
      io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.apiconfiguration.RestClient restClient) {
