...
public class Sysprep implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.volumes.sysprep.ConfigMap configMap;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.volumes.sysprep.ConfigMap getConfigMap() {
        return configMap;
    }

    public void setConfigMap(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.volumes.sysprep.ConfigMap configMap) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.volumes.sysprep.Secret secret;

    public io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.volumes.sysprep.Secret getSecret() {
        return secret;
    }

    public void setSecret(
            io.quarkiverse.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.volumes.sysprep.Secret secret) {
        this.secret = secret;
    }
}
