...
public class SeccompConfiguration implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.seccompconfiguration.VirtualMachineInstanceProfile virtualMachineInstanceProfile;

  public io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.seccompconfiguration.VirtualMachineInstanceProfile getVirtualMachineInstanceProfile() {
    return virtualMachineInstanceProfile;
  }

  public void setVirtualMachineInstanceProfile(
      io.quarkiverse.kubevirt.v1alpha3.kubevirtspec.configuration.seccompconfiguration.VirtualMachineInstanceProfile virtualMachineInstanceProfile) {
