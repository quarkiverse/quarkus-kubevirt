...
public class TopologySpreadConstraints implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.topologyspreadconstraints.LabelSelector labelSelector;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.topologyspreadconstraints.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.topologyspreadconstraints.LabelSelector labelSelector) {
