...
public class DataVolumeTemplates implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.Metadata metadata;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.Metadata metadata) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.Spec spec;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.Spec getSpec() {
        return spec;
    }

    public void setSpec(io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.Spec spec) {
        this.spec = spec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.Status status;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.Status getStatus() {
        return status;
    }

    public void setStatus(io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.Status status) {
        this.status = status;
    }
}
