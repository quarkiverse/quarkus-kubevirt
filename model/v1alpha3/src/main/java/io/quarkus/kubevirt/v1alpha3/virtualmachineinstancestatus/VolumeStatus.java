package io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus;
...
public class VolumeStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.HotplugVolume hotplugVolume;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.HotplugVolume getHotplugVolume() {
        return hotplugVolume;
    }

    public void setHotplugVolume(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.HotplugVolume hotplugVolume) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.MemoryDumpVolume memoryDumpVolume;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.MemoryDumpVolume getMemoryDumpVolume() {
        return memoryDumpVolume;
    }

    public void setMemoryDumpVolume(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.MemoryDumpVolume memoryDumpVolume) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.PersistentVolumeClaimInfo persistentVolumeClaimInfo;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.PersistentVolumeClaimInfo getPersistentVolumeClaimInfo() {
        return persistentVolumeClaimInfo;
    }

    public void setPersistentVolumeClaimInfo(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.volumestatus.PersistentVolumeClaimInfo persistentVolumeClaimInfo) {
