...
public class VirtualMachineInstancePresetSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.Domain domain;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.Domain getDomain() {
        return domain;
    }

    public void setDomain(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.Domain domain) {
        this.domain = domain;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.Selector selector;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.Selector getSelector() {
        return selector;
    }

    public void setSelector(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.Selector selector) {
