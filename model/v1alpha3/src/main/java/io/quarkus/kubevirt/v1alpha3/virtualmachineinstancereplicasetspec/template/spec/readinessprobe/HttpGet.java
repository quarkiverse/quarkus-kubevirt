package io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.readinessprobe;
...
public class HttpGet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.readinessprobe.httpget.HttpHeaders> httpHeaders;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.readinessprobe.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.readinessprobe.httpget.HttpHeaders> httpHeaders) {
