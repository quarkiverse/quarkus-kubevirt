package io.quarkus.kubevirt.v1alpha3.kubevirtspec.certificaterotatestrategy;
...
public class SelfSigned implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.kubevirtspec.certificaterotatestrategy.selfsigned.Ca ca;

    public io.quarkus.kubevirt.v1alpha3.kubevirtspec.certificaterotatestrategy.selfsigned.Ca getCa() {
        return ca;
    }

    public void setCa(io.quarkus.kubevirt.v1alpha3.kubevirtspec.certificaterotatestrategy.selfsigned.Ca ca) {
        this.ca = ca;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.kubevirtspec.certificaterotatestrategy.selfsigned.Server server;

    public io.quarkus.kubevirt.v1alpha3.kubevirtspec.certificaterotatestrategy.selfsigned.Server getServer() {
        return server;
    }

    public void setServer(io.quarkus.kubevirt.v1alpha3.kubevirtspec.certificaterotatestrategy.selfsigned.Server server) {
        this.server = server;
    }
}
