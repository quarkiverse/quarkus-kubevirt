package io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.controllerconfiguration;
...
public class RestClient implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.controllerconfiguration.restclient.RateLimiter rateLimiter;

    public io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.controllerconfiguration.restclient.RateLimiter getRateLimiter() {
        return rateLimiter;
    }

    public void setRateLimiter(
            io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.controllerconfiguration.restclient.RateLimiter rateLimiter) {
