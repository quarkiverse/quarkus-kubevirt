...
public class Filesystems implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.filesystems.Virtiofs virtiofs;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.filesystems.Virtiofs getVirtiofs() {
        return virtiofs;
    }

    public void setVirtiofs(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.filesystems.Virtiofs virtiofs) {
