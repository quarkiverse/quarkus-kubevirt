package io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.topologyspreadconstraints;
...
public class LabelSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.topologyspreadconstraints.labelselector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.topologyspreadconstraints.labelselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.topologyspreadconstraints.labelselector.MatchExpressions> matchExpressions) {
