package io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices;
...
public class Interfaces implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Bridge bridge;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Bridge getBridge() {
        return bridge;
    }

    public void setBridge(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Bridge bridge) {
        this.bridge = bridge;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.DhcpOptions dhcpOptions;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.DhcpOptions getDhcpOptions() {
        return dhcpOptions;
    }

    public void setDhcpOptions(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.DhcpOptions dhcpOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Macvtap macvtap;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Macvtap getMacvtap() {
        return macvtap;
    }

    public void setMacvtap(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Macvtap macvtap) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Masquerade masquerade;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Masquerade getMasquerade() {
        return masquerade;
    }

    public void setMasquerade(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Masquerade masquerade) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Passt passt;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Passt getPasst() {
        return passt;
    }

    public void setPasst(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Passt passt) {
        this.passt = passt;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Ports> ports;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Ports> getPorts() {
        return ports;
    }

    public void setPorts(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Ports> ports) {
        this.ports = ports;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Slirp slirp;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Slirp getSlirp() {
        return slirp;
    }

    public void setSlirp(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Slirp slirp) {
        this.slirp = slirp;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Sriov sriov;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Sriov getSriov() {
        return sriov;
    }

    public void setSriov(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancepresetspec.domain.devices.interfaces.Sriov sriov) {
        this.sriov = sriov;
    }
