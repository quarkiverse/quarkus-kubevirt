...
public class DownwardAPI implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.downwardapi.Fields> fields;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.downwardapi.Fields> getFields() {
        return fields;
    }

    public void setFields(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.downwardapi.Fields> fields) {
        this.fields = fields;
    }
