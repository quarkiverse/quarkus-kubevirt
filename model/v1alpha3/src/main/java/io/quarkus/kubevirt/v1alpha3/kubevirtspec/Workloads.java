...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "nodePlacement", "replicas" })
...
public class Workloads implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.kubevirtspec.workloads.NodePlacement nodePlacement;

    public io.quarkus.kubevirt.v1alpha3.kubevirtspec.workloads.NodePlacement getNodePlacement() {
        return nodePlacement;
    }

    public void setNodePlacement(io.quarkus.kubevirt.v1alpha3.kubevirtspec.workloads.NodePlacement nodePlacement) {
