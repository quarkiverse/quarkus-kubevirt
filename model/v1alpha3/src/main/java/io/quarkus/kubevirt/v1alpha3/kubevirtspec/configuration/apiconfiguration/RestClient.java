package io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.apiconfiguration;
...
public class RestClient implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.apiconfiguration.restclient.RateLimiter rateLimiter;

    public io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.apiconfiguration.restclient.RateLimiter getRateLimiter() {
        return rateLimiter;
    }

    public void setRateLimiter(
            io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.apiconfiguration.restclient.RateLimiter rateLimiter) {
