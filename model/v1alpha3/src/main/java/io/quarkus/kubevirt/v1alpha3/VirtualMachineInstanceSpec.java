...
public class VirtualMachineInstanceSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.AccessCredentials> accessCredentials;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.AccessCredentials> getAccessCredentials() {
        return accessCredentials;
    }

    public void setAccessCredentials(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.AccessCredentials> accessCredentials) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Affinity affinity;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.DnsConfig dnsConfig;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.DnsConfig getDnsConfig() {
        return dnsConfig;
    }

    public void setDnsConfig(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.DnsConfig dnsConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Domain domain;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Domain getDomain() {
        return domain;
    }

    public void setDomain(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Domain domain) {
        this.domain = domain;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.LivenessProbe livenessProbe;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.LivenessProbe getLivenessProbe() {
        return livenessProbe;
    }

    public void setLivenessProbe(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.LivenessProbe livenessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Networks> networks;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Networks> getNetworks() {
        return networks;
    }

    public void setNetworks(java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Networks> networks) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.ReadinessProbe readinessProbe;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.ReadinessProbe getReadinessProbe() {
        return readinessProbe;
    }

    public void setReadinessProbe(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.ReadinessProbe readinessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Tolerations> tolerations;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Tolerations> tolerations) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.TopologySpreadConstraints> topologySpreadConstraints;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.TopologySpreadConstraints> getTopologySpreadConstraints() {
        return topologySpreadConstraints;
    }

    public void setTopologySpreadConstraints(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.TopologySpreadConstraints> topologySpreadConstraints) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Volumes> volumes;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Volumes> getVolumes() {
        return volumes;
    }

    public void setVolumes(java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.Volumes> volumes) {
