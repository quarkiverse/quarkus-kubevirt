...
public class Firmware implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.firmware.Bootloader bootloader;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.firmware.Bootloader getBootloader() {
        return bootloader;
    }

    public void setBootloader(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.firmware.Bootloader bootloader) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.firmware.KernelBoot kernelBoot;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.firmware.KernelBoot getKernelBoot() {
        return kernelBoot;
    }

    public void setKernelBoot(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.firmware.KernelBoot kernelBoot) {
