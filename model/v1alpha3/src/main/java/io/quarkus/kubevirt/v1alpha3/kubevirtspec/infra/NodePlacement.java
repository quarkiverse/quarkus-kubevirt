package io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra;
...
public class NodePlacement implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra.nodeplacement.Affinity affinity;

    public io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra.nodeplacement.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra.nodeplacement.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra.nodeplacement.Tolerations> tolerations;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra.nodeplacement.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(
            java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra.nodeplacement.Tolerations> tolerations) {
