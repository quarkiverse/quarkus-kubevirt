...
public class VirtualMachineStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.Conditions> conditions) {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.MemoryDumpRequest memoryDumpRequest;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.MemoryDumpRequest getMemoryDumpRequest() {
        return memoryDumpRequest;
    }

    public void setMemoryDumpRequest(io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.MemoryDumpRequest memoryDumpRequest) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.StartFailure startFailure;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.StartFailure getStartFailure() {
        return startFailure;
    }

    public void setStartFailure(io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.StartFailure startFailure) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.StateChangeRequests> stateChangeRequests;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.StateChangeRequests> getStateChangeRequests() {
        return stateChangeRequests;
    }

    public void setStateChangeRequests(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.StateChangeRequests> stateChangeRequests) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.VolumeRequests> volumeRequests;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.VolumeRequests> getVolumeRequests() {
        return volumeRequests;
    }

    public void setVolumeRequests(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.VolumeRequests> volumeRequests) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.VolumeSnapshotStatuses> volumeSnapshotStatuses;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.VolumeSnapshotStatuses> getVolumeSnapshotStatuses() {
        return volumeSnapshotStatuses;
    }

    public void setVolumeSnapshotStatuses(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachinestatus.VolumeSnapshotStatuses> volumeSnapshotStatuses) {
