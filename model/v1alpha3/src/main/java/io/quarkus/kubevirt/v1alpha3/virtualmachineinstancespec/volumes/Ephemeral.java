...
public class Ephemeral implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ephemeral.PersistentVolumeClaim persistentVolumeClaim;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ephemeral.PersistentVolumeClaim getPersistentVolumeClaim() {
        return persistentVolumeClaim;
    }

    public void setPersistentVolumeClaim(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ephemeral.PersistentVolumeClaim persistentVolumeClaim) {
