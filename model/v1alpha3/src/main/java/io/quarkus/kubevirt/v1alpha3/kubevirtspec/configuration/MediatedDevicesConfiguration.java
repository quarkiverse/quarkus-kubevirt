...
public class MediatedDevicesConfiguration implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.mediateddevicesconfiguration.NodeMediatedDeviceTypes> nodeMediatedDeviceTypes;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.mediateddevicesconfiguration.NodeMediatedDeviceTypes> getNodeMediatedDeviceTypes() {
        return nodeMediatedDeviceTypes;
    }

    public void setNodeMediatedDeviceTypes(
            java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtspec.configuration.mediateddevicesconfiguration.NodeMediatedDeviceTypes> nodeMediatedDeviceTypes) {
