...
public class Networks implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Multus multus;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Multus getMultus() {
        return multus;
    }

    public void setMultus(io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Multus multus) {
        this.multus = multus;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Pod pod;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Pod getPod() {
        return pod;
    }

    public void setPod(io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.networks.Pod pod) {
        this.pod = pod;
    }
}
