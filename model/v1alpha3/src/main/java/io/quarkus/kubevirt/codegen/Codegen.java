...
@TemplateTransformations(annotations = @AnnotationSelector(io.fabric8.kubernetes.model.annotation.Group.class), value = {
        ...
        @TemplateTransformation(value = "/dsl.vm", outputPath = "io/quarkus/kubevirt/v1alpha3/Dsl.java", gather = true),
        @TemplateTransformation(value = "/client.vm", outputPath = "io/quarkus/kubevirt/v1alpha3/Client.java", gather = true)
})
