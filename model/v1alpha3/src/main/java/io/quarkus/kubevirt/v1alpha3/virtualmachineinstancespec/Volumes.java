package io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec;
...
public class Volumes implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.CloudInitConfigDrive cloudInitConfigDrive;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.CloudInitConfigDrive getCloudInitConfigDrive() {
        return cloudInitConfigDrive;
    }

    public void setCloudInitConfigDrive(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.CloudInitConfigDrive cloudInitConfigDrive) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.CloudInitNoCloud cloudInitNoCloud;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.CloudInitNoCloud getCloudInitNoCloud() {
        return cloudInitNoCloud;
    }

    public void setCloudInitNoCloud(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.CloudInitNoCloud cloudInitNoCloud) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ConfigMap configMap;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ConfigMap getConfigMap() {
        return configMap;
    }

    public void setConfigMap(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ConfigMap configMap) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ContainerDisk containerDisk;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ContainerDisk getContainerDisk() {
        return containerDisk;
    }

    public void setContainerDisk(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ContainerDisk containerDisk) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.DataVolume dataVolume;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.DataVolume getDataVolume() {
        return dataVolume;
    }

    public void setDataVolume(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.DataVolume dataVolume) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.DownwardAPI downwardAPI;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.DownwardAPI getDownwardAPI() {
        return downwardAPI;
    }

    public void setDownwardAPI(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.DownwardAPI downwardAPI) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.DownwardMetrics downwardMetrics;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.DownwardMetrics getDownwardMetrics() {
        return downwardMetrics;
    }

    public void setDownwardMetrics(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.DownwardMetrics downwardMetrics) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.EmptyDisk emptyDisk;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.EmptyDisk getEmptyDisk() {
        return emptyDisk;
    }

    public void setEmptyDisk(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.EmptyDisk emptyDisk) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.Ephemeral ephemeral;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.Ephemeral getEphemeral() {
        return ephemeral;
    }

    public void setEphemeral(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.Ephemeral ephemeral) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.HostDisk hostDisk;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.HostDisk getHostDisk() {
        return hostDisk;
    }

    public void setHostDisk(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.HostDisk hostDisk) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.MemoryDump memoryDump;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.MemoryDump getMemoryDump() {
        return memoryDump;
    }

    public void setMemoryDump(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.MemoryDump memoryDump) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.PersistentVolumeClaim persistentVolumeClaim;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.PersistentVolumeClaim getPersistentVolumeClaim() {
        return persistentVolumeClaim;
    }

    public void setPersistentVolumeClaim(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.PersistentVolumeClaim persistentVolumeClaim) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.Secret secret;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.Secret getSecret() {
        return secret;
    }

    public void setSecret(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.Secret secret) {
        this.secret = secret;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ServiceAccount serviceAccount;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ServiceAccount getServiceAccount() {
        return serviceAccount;
    }

    public void setServiceAccount(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.ServiceAccount serviceAccount) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.Sysprep sysprep;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.Sysprep getSysprep() {
        return sysprep;
    }

    public void setSysprep(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.volumes.Sysprep sysprep) {
