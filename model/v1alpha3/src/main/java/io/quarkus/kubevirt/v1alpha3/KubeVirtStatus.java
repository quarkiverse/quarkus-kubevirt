...
public class KubeVirtStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtstatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtstatus.Conditions> conditions) {
        this.conditions = conditions;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("generations")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtstatus.Generations> generations;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtstatus.Generations> getGenerations() {
        return generations;
    }

    public void setGenerations(java.util.List<io.quarkus.kubevirt.v1alpha3.kubevirtstatus.Generations> generations) {
