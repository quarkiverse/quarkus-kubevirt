...
public class Storage implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.storage.DataSource dataSource;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.storage.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(
            io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.storage.DataSource dataSource) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.storage.Resources resources;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.storage.Resources getResources() {
        return resources;
    }

    public void setResources(
            io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.storage.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.storage.Selector selector;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.storage.Selector getSelector() {
        return selector;
    }

    public void setSelector(
            io.quarkus.kubevirt.v1alpha3.virtualmachinespec.datavolumetemplates.spec.storage.Selector selector) {
