...
public class SshPublicKey implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.accesscredentials.sshpublickey.PropagationMethod propagationMethod;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.accesscredentials.sshpublickey.PropagationMethod getPropagationMethod() {
        return propagationMethod;
    }

    public void setPropagationMethod(
            io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.accesscredentials.sshpublickey.PropagationMethod propagationMethod) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.accesscredentials.sshpublickey.Source source;

    public io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.accesscredentials.sshpublickey.Source getSource() {
        return source;
    }

    public void setSource(
            io.quarkus.kubevirt.v1alpha3.virtualmachinespec.template.spec.accesscredentials.sshpublickey.Source source) {
        this.source = source;
    }
}
