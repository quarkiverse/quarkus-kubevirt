package io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.sshpublickey;
...
public class PropagationMethod implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.sshpublickey.propagationmethod.ConfigDrive configDrive;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.sshpublickey.propagationmethod.ConfigDrive getConfigDrive() {
        return configDrive;
    }

    public void setConfigDrive(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.sshpublickey.propagationmethod.ConfigDrive configDrive) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.sshpublickey.propagationmethod.QemuGuestAgent qemuGuestAgent;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.sshpublickey.propagationmethod.QemuGuestAgent getQemuGuestAgent() {
        return qemuGuestAgent;
    }

    public void setQemuGuestAgent(
            io.quarkus.kubevirt.v1alpha3.virtualmachineinstancespec.accesscredentials.sshpublickey.propagationmethod.QemuGuestAgent qemuGuestAgent) {
