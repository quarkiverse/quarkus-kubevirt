...
public class Infra implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra.NodePlacement nodePlacement;

    public io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra.NodePlacement getNodePlacement() {
        return nodePlacement;
    }

    public void setNodePlacement(io.quarkus.kubevirt.v1alpha3.kubevirtspec.infra.NodePlacement nodePlacement) {
