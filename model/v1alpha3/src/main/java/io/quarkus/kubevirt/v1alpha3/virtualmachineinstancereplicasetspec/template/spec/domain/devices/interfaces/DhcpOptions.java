package io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.devices.interfaces;
...
public class DhcpOptions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.devices.interfaces.dhcpoptions.PrivateOptions> privateOptions;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.devices.interfaces.dhcpoptions.PrivateOptions> getPrivateOptions() {
        return privateOptions;
    }

    public void setPrivateOptions(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancereplicasetspec.template.spec.domain.devices.interfaces.dhcpoptions.PrivateOptions> privateOptions) {
