...
public class VirtualMachineInstanceStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.Conditions> conditions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.GuestOSInfo guestOSInfo;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.GuestOSInfo getGuestOSInfo() {
        return guestOSInfo;
    }

    public void setGuestOSInfo(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.GuestOSInfo guestOSInfo) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.Interfaces> interfaces;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.Interfaces> getInterfaces() {
        return interfaces;
    }

    public void setInterfaces(java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.Interfaces> interfaces) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.MigrationState migrationState;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.MigrationState getMigrationState() {
        return migrationState;
    }

    public void setMigrationState(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.MigrationState migrationState) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.PhaseTransitionTimestamps> phaseTransitionTimestamps;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.PhaseTransitionTimestamps> getPhaseTransitionTimestamps() {
        return phaseTransitionTimestamps;
    }

    public void setPhaseTransitionTimestamps(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.PhaseTransitionTimestamps> phaseTransitionTimestamps) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.TopologyHints topologyHints;

    public io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.TopologyHints getTopologyHints() {
        return topologyHints;
    }

    public void setTopologyHints(io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.TopologyHints topologyHints) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.VolumeStatus> volumeStatus;

    public java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.VolumeStatus> getVolumeStatus() {
        return volumeStatus;
    }

    public void setVolumeStatus(
            java.util.List<io.quarkus.kubevirt.v1alpha3.virtualmachineinstancestatus.VolumeStatus> volumeStatus) {
