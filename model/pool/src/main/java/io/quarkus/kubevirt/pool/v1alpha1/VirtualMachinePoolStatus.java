...
public class VirtualMachinePoolStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {

    @com.fasterxml.jackson.annotation.JsonProperty("conditions")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.pool.v1alpha1.virtualmachinepoolstatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.pool.v1alpha1.virtualmachinepoolstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(
            java.util.List<io.quarkus.kubevirt.pool.v1alpha1.virtualmachinepoolstatus.Conditions> conditions) {
