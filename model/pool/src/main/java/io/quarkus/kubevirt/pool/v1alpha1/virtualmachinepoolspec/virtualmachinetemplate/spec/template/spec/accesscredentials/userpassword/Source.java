...
public class Source implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.pool.v1alpha1.virtualmachinepoolspec.virtualmachinetemplate.spec.template.spec.accesscredentials.userpassword.source.Secret secret;

    public io.quarkus.kubevirt.pool.v1alpha1.virtualmachinepoolspec.virtualmachinetemplate.spec.template.spec.accesscredentials.userpassword.source.Secret getSecret() {
        return secret;
    }

    public void setSecret(
            io.quarkus.kubevirt.pool.v1alpha1.virtualmachinepoolspec.virtualmachinetemplate.spec.template.spec.accesscredentials.userpassword.source.Secret secret) {
        this.secret = secret;
    }
}
