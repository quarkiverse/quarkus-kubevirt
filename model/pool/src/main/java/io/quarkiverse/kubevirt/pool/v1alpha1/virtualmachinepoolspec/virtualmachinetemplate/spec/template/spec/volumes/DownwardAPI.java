...
public class DownwardAPI implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.pool.v1alpha1.virtualmachinepoolspec.virtualmachinetemplate.spec.template.spec.volumes.downwardapi.Fields> fields;

    public java.util.List<io.quarkiverse.kubevirt.pool.v1alpha1.virtualmachinepoolspec.virtualmachinetemplate.spec.template.spec.volumes.downwardapi.Fields> getFields() {
        return fields;
    }

    public void setFields(
            java.util.List<io.quarkiverse.kubevirt.pool.v1alpha1.virtualmachinepoolspec.virtualmachinetemplate.spec.template.spec.volumes.downwardapi.Fields> fields) {
        this.fields = fields;
    }
