package io.quarkiverse.kubevirt.snapshot.v1alpha1.virtualmachinerestorestatus;

@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "dataVolumeName", "persistentVolumeClaim", "volumeName",
        "volumeSnapshotName" })
...
public class Restores implements io.fabric8.kubernetes.api.model.KubernetesResource {
