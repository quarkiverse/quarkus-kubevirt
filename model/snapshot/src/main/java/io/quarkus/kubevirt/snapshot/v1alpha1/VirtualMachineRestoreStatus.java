...
public class VirtualMachineRestoreStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinerestorestatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinerestorestatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(
            java.util.List<io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinerestorestatus.Conditions> conditions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinerestorestatus.Restores> restores;

    public java.util.List<io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinerestorestatus.Restores> getRestores() {
        return restores;
    }

    public void setRestores(
            java.util.List<io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinerestorestatus.Restores> restores) {
