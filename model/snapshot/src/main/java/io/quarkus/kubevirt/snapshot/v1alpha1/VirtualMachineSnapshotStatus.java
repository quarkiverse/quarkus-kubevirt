...
public class VirtualMachineSnapshotStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotstatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(
            java.util.List<io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotstatus.Conditions> conditions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotstatus.Error error;

    public io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotstatus.Error getError() {
        return error;
    }

    public void setError(io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotstatus.Error error) {
        this.error = error;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotstatus.SnapshotVolumes snapshotVolumes;

    public io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotstatus.SnapshotVolumes getSnapshotVolumes() {
        return snapshotVolumes;
    }

    public void setSnapshotVolumes(
            io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotstatus.SnapshotVolumes snapshotVolumes) {
