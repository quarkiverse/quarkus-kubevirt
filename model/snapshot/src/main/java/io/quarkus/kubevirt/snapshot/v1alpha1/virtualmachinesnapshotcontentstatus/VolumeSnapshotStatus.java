package io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentstatus;
...
public class VolumeSnapshotStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentstatus.volumesnapshotstatus.Error error;

    public io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentstatus.volumesnapshotstatus.Error getError() {
        return error;
    }

    public void setError(
            io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentstatus.volumesnapshotstatus.Error error) {
        this.error = error;
    }
