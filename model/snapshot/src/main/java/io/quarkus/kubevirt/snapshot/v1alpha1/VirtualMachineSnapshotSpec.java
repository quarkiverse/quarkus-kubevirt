...
public class VirtualMachineSnapshotSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotspec.Source source;

    public io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotspec.Source getSource() {
        return source;
    }

    public void setSource(io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotspec.Source source) {
        this.source = source;
    }
}
