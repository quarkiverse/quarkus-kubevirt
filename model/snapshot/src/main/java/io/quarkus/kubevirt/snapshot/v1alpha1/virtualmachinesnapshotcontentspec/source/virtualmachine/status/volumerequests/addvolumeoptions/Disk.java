package io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions;
...
public class Disk implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.BlockSize blockSize;

    public io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.BlockSize getBlockSize() {
        return blockSize;
    }

    public void setBlockSize(
            io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.BlockSize blockSize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.Cdrom cdrom;

    public io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.Cdrom getCdrom() {
        return cdrom;
    }

    public void setCdrom(
            io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.Cdrom cdrom) {
        this.cdrom = cdrom;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.Disk disk;

    public io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.Disk getDisk() {
        return disk;
    }

    public void setDisk(
            io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.Disk disk) {
        this.disk = disk;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.Lun lun;

    public io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.Lun getLun() {
        return lun;
    }

    public void setLun(
            io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinesnapshotcontentspec.source.virtualmachine.status.volumerequests.addvolumeoptions.disk.Lun lun) {
        this.lun = lun;
    }
