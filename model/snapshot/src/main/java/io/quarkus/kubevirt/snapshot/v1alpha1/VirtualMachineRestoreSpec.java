...
public class VirtualMachineRestoreSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinerestorespec.Target target;

    public io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinerestorespec.Target getTarget() {
        return target;
    }

    public void setTarget(io.quarkus.kubevirt.snapshot.v1alpha1.virtualmachinerestorespec.Target target) {
        this.target = target;
    }
