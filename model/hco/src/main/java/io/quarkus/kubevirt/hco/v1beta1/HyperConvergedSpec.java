...
public class HyperConvergedSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.CertConfig certConfig = io.fabric8.kubernetes.client.utils.Serialization
            .unmarshal(
                    "{\"ca\":{\"duration\":\"48h0m0s\",\"renewBefore\":\"24h0m0s\"},\"server\":{\"duration\":\"24h0m0s\",\"renewBefore\":\"12h0m0s\"}}",
                    io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.CertConfig.class);

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.CertConfig getCertConfig() {
        return certConfig;
    }

    public void setCertConfig(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.CertConfig certConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.DataImportCronTemplates> dataImportCronTemplates;

    public java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.DataImportCronTemplates> getDataImportCronTemplates() {
        return dataImportCronTemplates;
    }

    public void setDataImportCronTemplates(
            java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.DataImportCronTemplates> dataImportCronTemplates) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.FeatureGates featureGates = io.fabric8.kubernetes.client.utils.Serialization
            .unmarshal(
                    ...
                    io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.FeatureGates.class);

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.FeatureGates getFeatureGates() {
        return featureGates;
    }

    public void setFeatureGates(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.FeatureGates featureGates) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.FilesystemOverhead filesystemOverhead;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.FilesystemOverhead getFilesystemOverhead() {
        return filesystemOverhead;
    }

    public void setFilesystemOverhead(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.FilesystemOverhead filesystemOverhead) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.Infra infra;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.Infra getInfra() {
        return infra;
    }

    public void setInfra(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.Infra infra) {
        this.infra = infra;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.LiveMigrationConfig liveMigrationConfig = io.fabric8.kubernetes.client.utils.Serialization
            .unmarshal(
                    ...
                    io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.LiveMigrationConfig.class);

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.LiveMigrationConfig getLiveMigrationConfig() {
        return liveMigrationConfig;
    }

    public void setLiveMigrationConfig(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.LiveMigrationConfig liveMigrationConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.LogVerbosityConfig logVerbosityConfig;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.LogVerbosityConfig getLogVerbosityConfig() {
        return logVerbosityConfig;
    }

    public void setLogVerbosityConfig(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.LogVerbosityConfig logVerbosityConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.MediatedDevicesConfiguration mediatedDevicesConfiguration;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.MediatedDevicesConfiguration getMediatedDevicesConfiguration() {
        return mediatedDevicesConfiguration;
    }

    public void setMediatedDevicesConfiguration(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.MediatedDevicesConfiguration mediatedDevicesConfiguration) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.ObsoleteCPUs obsoleteCPUs;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.ObsoleteCPUs getObsoleteCPUs() {
        return obsoleteCPUs;
    }

    public void setObsoleteCPUs(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.ObsoleteCPUs obsoleteCPUs) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.PermittedHostDevices permittedHostDevices;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.PermittedHostDevices getPermittedHostDevices() {
        return permittedHostDevices;
    }

    public void setPermittedHostDevices(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.PermittedHostDevices permittedHostDevices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.ResourceRequirements resourceRequirements;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.ResourceRequirements getResourceRequirements() {
        return resourceRequirements;
    }

    public void setResourceRequirements(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.ResourceRequirements resourceRequirements) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.StorageImport storageImport;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.StorageImport getStorageImport() {
        return storageImport;
    }

    public void setStorageImport(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.StorageImport storageImport) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.TlsSecurityProfile tlsSecurityProfile;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.TlsSecurityProfile getTlsSecurityProfile() {
        return tlsSecurityProfile;
    }

    public void setTlsSecurityProfile(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.TlsSecurityProfile tlsSecurityProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.WorkloadUpdateStrategy workloadUpdateStrategy = io.fabric8.kubernetes.client.utils.Serialization
            .unmarshal(
                    "{\"batchEvictionInterval\":\"1m0s\",\"batchEvictionSize\":10,\"workloadUpdateMethods\":[\"LiveMigrate\"]}",
                    io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.WorkloadUpdateStrategy.class);

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.WorkloadUpdateStrategy getWorkloadUpdateStrategy() {
        return workloadUpdateStrategy;
    }

    public void setWorkloadUpdateStrategy(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.WorkloadUpdateStrategy workloadUpdateStrategy) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.Workloads workloads;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.Workloads getWorkloads() {
        return workloads;
    }

    public void setWorkloads(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.Workloads workloads) {
