...
public class ResourceRequirements implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.resourcerequirements.StorageWorkloads storageWorkloads;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.resourcerequirements.StorageWorkloads getStorageWorkloads() {
        return storageWorkloads;
    }

    public void setStorageWorkloads(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.resourcerequirements.StorageWorkloads storageWorkloads) {
