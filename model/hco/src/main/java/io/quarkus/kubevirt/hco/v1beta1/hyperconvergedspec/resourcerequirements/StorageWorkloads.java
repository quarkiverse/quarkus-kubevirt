package io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.resourcerequirements;
...
public class StorageWorkloads implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.resourcerequirements.storageworkloads.Claims> claims;

    public java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.resourcerequirements.storageworkloads.Claims> getClaims() {
        return claims;
    }

    public void setClaims(
            java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.resourcerequirements.storageworkloads.Claims> claims) {
        this.claims = claims;
    }
