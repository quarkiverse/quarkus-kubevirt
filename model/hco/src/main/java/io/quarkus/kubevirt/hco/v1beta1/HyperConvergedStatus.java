...
public class HyperConvergedStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.Conditions> conditions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.DataImportCronTemplates> dataImportCronTemplates;

    public java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.DataImportCronTemplates> getDataImportCronTemplates() {
        return dataImportCronTemplates;
    }

    public void setDataImportCronTemplates(
            java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.DataImportCronTemplates> dataImportCronTemplates) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.RelatedObjects> relatedObjects;

    public java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.RelatedObjects> getRelatedObjects() {
        return relatedObjects;
    }

    public void setRelatedObjects(
            java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.RelatedObjects> relatedObjects) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.Versions> versions;

    public java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.Versions> getVersions() {
        return versions;
    }

    public void setVersions(java.util.List<io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.Versions> versions) {
