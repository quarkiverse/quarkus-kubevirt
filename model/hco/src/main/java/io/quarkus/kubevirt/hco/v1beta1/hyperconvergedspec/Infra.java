...
public class Infra implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.infra.NodePlacement nodePlacement;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.infra.NodePlacement getNodePlacement() {
        return nodePlacement;
    }

    public void setNodePlacement(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.infra.NodePlacement nodePlacement) {
