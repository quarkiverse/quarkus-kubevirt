...
public class CertConfig implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.certconfig.Ca ca = io.fabric8.kubernetes.client.utils.Serialization
            .unmarshal("{\"duration\":\"48h0m0s\",\"renewBefore\":\"24h0m0s\"}",
                    io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.certconfig.Ca.class);

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.certconfig.Ca getCa() {
        return ca;
    }

    public void setCa(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.certconfig.Ca ca) {
        this.ca = ca;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.certconfig.Server server = io.fabric8.kubernetes.client.utils.Serialization
            .unmarshal("{\"duration\":\"24h0m0s\",\"renewBefore\":\"12h0m0s\"}",
                    io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.certconfig.Server.class);

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.certconfig.Server getServer() {
        return server;
    }

    public void setServer(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.certconfig.Server server) {
        this.server = server;
    }
}
