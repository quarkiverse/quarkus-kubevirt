...
public class Pvc implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.DataSource dataSource;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.DataSource dataSource) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.DataSourceRef dataSourceRef;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.DataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.DataSourceRef dataSourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.Resources resources;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.Resources getResources() {
        return resources;
    }

    public void setResources(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.Selector selector;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.Selector getSelector() {
        return selector;
    }

    public void setSelector(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.Selector selector) {
