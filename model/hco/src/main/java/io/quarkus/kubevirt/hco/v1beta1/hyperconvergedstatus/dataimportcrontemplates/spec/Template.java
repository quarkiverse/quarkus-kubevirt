package io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec;
...
public class Template implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.Metadata metadata;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.Metadata metadata) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.Spec spec;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.Spec getSpec() {
        return spec;
    }

    public void setSpec(io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.Spec spec) {
        this.spec = spec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.Status status;

    public io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.Status getStatus() {
        return status;
    }

    public void setStatus(
            io.quarkus.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.Status status) {
        this.status = status;
    }
}
