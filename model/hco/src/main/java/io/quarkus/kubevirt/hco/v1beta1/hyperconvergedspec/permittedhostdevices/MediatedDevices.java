package io.quarkus.kubevirt.hco.v1beta1.hyperconvergedspec.permittedhostdevices;

@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "disabled", "externalResourceProvider", "mdevNameSelector",
        "resourceName" })
...
public class MediatedDevices implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    /**
     * HCO enforces the existence of several MediatedHostDevice objects. Set disabled field to true instead of remove these
     * objects.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("disabled")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("HCO enforces the existence of several MediatedHostDevice objects. Set disabled field to true instead of remove these objects.")
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("name of a mediated device type required to identify a mediated device on a host")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
