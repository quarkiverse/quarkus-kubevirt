package io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.Template template;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.Template getTemplate() {
        return template;
    }

    public void setTemplate(
            io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.Template template) {
