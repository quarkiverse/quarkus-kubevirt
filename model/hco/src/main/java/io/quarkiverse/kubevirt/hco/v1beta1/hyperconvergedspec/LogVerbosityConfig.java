...
public class LogVerbosityConfig implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.logverbosityconfig.Kubevirt kubevirt;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.logverbosityconfig.Kubevirt getKubevirt() {
        return kubevirt;
    }

    public void setKubevirt(io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.logverbosityconfig.Kubevirt kubevirt) {
