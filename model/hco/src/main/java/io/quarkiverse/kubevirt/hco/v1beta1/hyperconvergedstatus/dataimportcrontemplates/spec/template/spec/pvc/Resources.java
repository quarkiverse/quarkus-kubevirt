...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.resources.Claims> claims;

    public java.util.List<io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(
            java.util.List<io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.pvc.resources.Claims> claims) {
        this.claims = claims;
    }
