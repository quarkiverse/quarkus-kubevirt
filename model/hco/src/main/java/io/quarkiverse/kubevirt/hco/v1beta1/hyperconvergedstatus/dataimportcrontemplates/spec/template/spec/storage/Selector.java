package io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage;
...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.selector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.selector.MatchExpressions> matchExpressions) {
