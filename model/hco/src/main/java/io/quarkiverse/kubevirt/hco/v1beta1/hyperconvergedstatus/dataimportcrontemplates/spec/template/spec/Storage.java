...
public class Storage implements io.fabric8.kubernetes.api.model.KubernetesResource {
     ...
     * contents of the specified data source. If the AnyVolumeDataSource feature gate is enabled, this field will always have
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.DataSource dataSource;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(
            io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.DataSource dataSource) {
     ...
     * DataSourceRef preserves all values, and generates an error if a disallowed value is specified. (Beta) Using this field
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.DataSourceRef dataSourceRef;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.DataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(
            io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.DataSourceRef dataSourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.Resources resources;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.Resources getResources() {
        return resources;
    }

    public void setResources(
            io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.Selector selector;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.Selector getSelector() {
        return selector;
    }

    public void setSelector(
            io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedstatus.dataimportcrontemplates.spec.template.spec.storage.Selector selector) {
