...
public class Infra implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.infra.NodePlacement nodePlacement;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.infra.NodePlacement getNodePlacement() {
        return nodePlacement;
    }

    public void setNodePlacement(io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.infra.NodePlacement nodePlacement) {
