package io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Checkpoints> checkpoints;

    public java.util.List<io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Checkpoints> getCheckpoints() {
        return checkpoints;
    }

    public void setCheckpoints(
            java.util.List<io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Checkpoints> checkpoints) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Pvc pvc;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Pvc getPvc() {
        return pvc;
    }

    public void setPvc(io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Pvc pvc) {
        this.pvc = pvc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Source source;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Source getSource() {
        return source;
    }

    public void setSource(
            io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Source source) {
        this.source = source;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.SourceRef sourceRef;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.SourceRef getSourceRef() {
        return sourceRef;
    }

    public void setSourceRef(
            io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.SourceRef sourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Storage storage;

    public io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Storage getStorage() {
        return storage;
    }

    public void setStorage(
            io.quarkiverse.kubevirt.hco.v1beta1.hyperconvergedspec.dataimportcrontemplates.spec.template.spec.Storage storage) {
