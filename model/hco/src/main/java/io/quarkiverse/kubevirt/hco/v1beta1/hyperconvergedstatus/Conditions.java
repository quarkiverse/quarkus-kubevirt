...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "lastTransitionTime", "message", "observedGeneration", "reason", "status",
        "type" })
...
public class Conditions implements io.fabric8.kubernetes.api.model.KubernetesResource {
     ...
     * .metadata.generation is currently 12, but the .status.conditions[x].observedGeneration is 9, the condition is out of date
     ...
     * deconflict is important. The regex it matches is (dns1123SubdomainFmt/)?(qualifiedNameFmt)
     */
