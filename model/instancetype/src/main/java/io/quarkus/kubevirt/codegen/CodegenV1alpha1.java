...
@TemplateTransformations(annotations = @AnnotationSelector(value = io.fabric8.kubernetes.model.annotation.Group.class, packages = @PackageSelector("io.quarkus.kubevirt.instancetype.v1alpha1")), value = {
        ...
        @TemplateTransformation(value = "/dsl.vm", outputPath = "io/quarkus/kubevirt/v1alpha1/Dsl.java", gather = true),
        @TemplateTransformation(value = "/client.vm", outputPath = "io/quarkus/kubevirt/v1alpha1/Client.java", gather = true)
})
