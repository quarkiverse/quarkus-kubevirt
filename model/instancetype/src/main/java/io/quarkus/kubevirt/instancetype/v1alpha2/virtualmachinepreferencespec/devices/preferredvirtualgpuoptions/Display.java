package io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.devices.preferredvirtualgpuoptions;
...
public class Display implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.devices.preferredvirtualgpuoptions.display.RamFB ramFB;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.devices.preferredvirtualgpuoptions.display.RamFB getRamFB() {
        return ramFB;
    }

    public void setRamFB(
            io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.devices.preferredvirtualgpuoptions.display.RamFB ramFB) {
        this.ramFB = ramFB;
    }
}
