...
public class Memory implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.memory.Hugepages hugepages;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.memory.Hugepages getHugepages() {
        return hugepages;
    }

    public void setHugepages(
            io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.memory.Hugepages hugepages) {
