package io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec;
...
public class Cpu implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.Numa numa;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.Numa getNuma() {
        return numa;
    }

    public void setNuma(io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.Numa numa) {
        this.numa = numa;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.Realtime realtime;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.Realtime getRealtime() {
        return realtime;
    }

    public void setRealtime(io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.Realtime realtime) {
