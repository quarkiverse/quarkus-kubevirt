...
public class Clock implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredClockOffset preferredClockOffset;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredClockOffset getPreferredClockOffset() {
        return preferredClockOffset;
    }

    public void setPreferredClockOffset(
            io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredClockOffset preferredClockOffset) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredTimer preferredTimer;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredTimer getPreferredTimer() {
        return preferredTimer;
    }

    public void setPreferredTimer(
            io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredTimer preferredTimer) {
