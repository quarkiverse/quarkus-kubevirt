...
public class Gpus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.gpus.VirtualGPUOptions virtualGPUOptions;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.gpus.VirtualGPUOptions getVirtualGPUOptions() {
        return virtualGPUOptions;
    }

    public void setVirtualGPUOptions(
            io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.gpus.VirtualGPUOptions virtualGPUOptions) {
