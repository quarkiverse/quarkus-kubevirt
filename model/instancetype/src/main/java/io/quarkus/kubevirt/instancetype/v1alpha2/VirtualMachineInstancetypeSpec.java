...
public class VirtualMachineInstancetypeSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.Cpu cpu;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.Cpu getCpu() {
        return cpu;
    }

    public void setCpu(io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.Cpu cpu) {
        this.cpu = cpu;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.Gpus> gpus;

    public java.util.List<io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.Gpus> getGpus() {
        return gpus;
    }

    public void setGpus(java.util.List<io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.Gpus> gpus) {
        this.gpus = gpus;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.HostDevices> hostDevices;

    public java.util.List<io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.HostDevices> getHostDevices() {
        return hostDevices;
    }

    public void setHostDevices(
            java.util.List<io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.HostDevices> hostDevices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.LaunchSecurity launchSecurity;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.LaunchSecurity getLaunchSecurity() {
        return launchSecurity;
    }

    public void setLaunchSecurity(
            io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.LaunchSecurity launchSecurity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.Memory memory;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.Memory getMemory() {
        return memory;
    }

    public void setMemory(io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.Memory memory) {
        this.memory = memory;
    }
}
