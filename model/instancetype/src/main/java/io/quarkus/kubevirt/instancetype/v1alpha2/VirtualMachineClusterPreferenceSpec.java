...
public class VirtualMachineClusterPreferenceSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Clock clock;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Clock getClock() {
        return clock;
    }

    public void setClock(io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Clock clock) {
        this.clock = clock;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Cpu cpu;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Cpu getCpu() {
        return cpu;
    }

    public void setCpu(io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Cpu cpu) {
        this.cpu = cpu;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Devices devices;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Devices getDevices() {
        return devices;
    }

    public void setDevices(io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Devices devices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Features features;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Features getFeatures() {
        return features;
    }

    public void setFeatures(io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Features features) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Firmware firmware;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Firmware getFirmware() {
        return firmware;
    }

    public void setFirmware(io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Firmware firmware) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Machine machine;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Machine getMachine() {
        return machine;
    }

    public void setMachine(io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Machine machine) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Volumes volumes;

    public io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Volumes getVolumes() {
        return volumes;
    }

    public void setVolumes(io.quarkus.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.Volumes volumes) {
