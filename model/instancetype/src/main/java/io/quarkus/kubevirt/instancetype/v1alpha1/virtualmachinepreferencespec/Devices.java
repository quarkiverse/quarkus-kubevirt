...
public class Devices implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredDiskBlockSize preferredDiskBlockSize;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredDiskBlockSize getPreferredDiskBlockSize() {
        return preferredDiskBlockSize;
    }

    public void setPreferredDiskBlockSize(
            io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredDiskBlockSize preferredDiskBlockSize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredRng preferredRng;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredRng getPreferredRng() {
        return preferredRng;
    }

    public void setPreferredRng(
            io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredRng preferredRng) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredTPM preferredTPM;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredTPM getPreferredTPM() {
        return preferredTPM;
    }

    public void setPreferredTPM(
            io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredTPM preferredTPM) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredVirtualGPUOptions preferredVirtualGPUOptions;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredVirtualGPUOptions getPreferredVirtualGPUOptions() {
        return preferredVirtualGPUOptions;
    }

    public void setPreferredVirtualGPUOptions(
            io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.devices.PreferredVirtualGPUOptions preferredVirtualGPUOptions) {
