package io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu;
...
public class Numa implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.numa.GuestMappingPassthrough guestMappingPassthrough;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.numa.GuestMappingPassthrough getGuestMappingPassthrough() {
        return guestMappingPassthrough;
    }

    public void setGuestMappingPassthrough(
            io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.numa.GuestMappingPassthrough guestMappingPassthrough) {
