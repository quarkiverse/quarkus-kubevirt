...
public class PreferredClockOffset implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.clock.preferredclockoffset.Utc utc;

    public io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.clock.preferredclockoffset.Utc getUtc() {
        return utc;
    }

    public void setUtc(
            io.quarkus.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.clock.preferredclockoffset.Utc utc) {
        this.utc = utc;
    }
}
