...
public class Devices implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredDiskBlockSize preferredDiskBlockSize;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredDiskBlockSize getPreferredDiskBlockSize() {
        return preferredDiskBlockSize;
    }

    public void setPreferredDiskBlockSize(
            io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredDiskBlockSize preferredDiskBlockSize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredRng preferredRng;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredRng getPreferredRng() {
        return preferredRng;
    }

    public void setPreferredRng(
            io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredRng preferredRng) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredTPM preferredTPM;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredTPM getPreferredTPM() {
        return preferredTPM;
    }

    public void setPreferredTPM(
            io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredTPM preferredTPM) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredVirtualGPUOptions preferredVirtualGPUOptions;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredVirtualGPUOptions getPreferredVirtualGPUOptions() {
        return preferredVirtualGPUOptions;
    }

    public void setPreferredVirtualGPUOptions(
            io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.PreferredVirtualGPUOptions preferredVirtualGPUOptions) {
