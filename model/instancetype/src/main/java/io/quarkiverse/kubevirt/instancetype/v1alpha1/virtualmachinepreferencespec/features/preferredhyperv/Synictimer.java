...
public class Synictimer implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.preferredhyperv.synictimer.Direct direct;

    public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.preferredhyperv.synictimer.Direct getDirect() {
        return direct;
    }

    public void setDirect(
            io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.preferredhyperv.synictimer.Direct direct) {
        this.direct = direct;
    }
