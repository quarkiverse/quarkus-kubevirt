...
public class Clock implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.clock.PreferredClockOffset preferredClockOffset;

  public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.clock.PreferredClockOffset getPreferredClockOffset() {
    return preferredClockOffset;
  }

  public void setPreferredClockOffset(
      io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.clock.PreferredClockOffset preferredClockOffset) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.clock.PreferredTimer preferredTimer;

  public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.clock.PreferredTimer getPreferredTimer() {
    return preferredTimer;
  }

  public void setPreferredTimer(
      io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.clock.PreferredTimer preferredTimer) {
