...
public class LaunchSecurity implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.launchsecurity.Sev sev;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.launchsecurity.Sev getSev() {
    return sev;
  }

  public void setSev(io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.launchsecurity.Sev sev) {
    this.sev = sev;
  }
}
