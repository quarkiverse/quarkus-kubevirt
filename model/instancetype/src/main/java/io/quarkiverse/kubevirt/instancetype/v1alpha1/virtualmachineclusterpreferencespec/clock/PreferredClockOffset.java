...
public class PreferredClockOffset implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.preferredclockoffset.Utc utc;

    public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.preferredclockoffset.Utc getUtc() {
        return utc;
    }

    public void setUtc(
            io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.preferredclockoffset.Utc utc) {
        this.utc = utc;
    }
}
