...
public class VirtualMachineClusterPreferenceSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Clock clock;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Clock getClock() {
    return clock;
  }

  public void setClock(io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Clock clock) {
    this.clock = clock;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Cpu cpu;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Cpu getCpu() {
    return cpu;
  }

  public void setCpu(io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Cpu cpu) {
    this.cpu = cpu;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Devices devices;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Devices getDevices() {
    return devices;
  }

  public void setDevices(io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Devices devices) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Features features;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Features getFeatures() {
    return features;
  }

  public void setFeatures(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Features features) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Firmware firmware;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Firmware getFirmware() {
    return firmware;
  }

  public void setFirmware(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Firmware firmware) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Machine machine;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Machine getMachine() {
    return machine;
  }

  public void setMachine(io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Machine machine) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Volumes volumes;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Volumes getVolumes() {
    return volumes;
  }

  public void setVolumes(io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.Volumes volumes) {
