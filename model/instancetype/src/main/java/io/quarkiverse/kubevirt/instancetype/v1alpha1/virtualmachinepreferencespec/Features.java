...
public class Features implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredAcpi preferredAcpi;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredAcpi getPreferredAcpi() {
    return preferredAcpi;
  }

  public void setPreferredAcpi(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredAcpi preferredAcpi) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredApic preferredApic;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredApic getPreferredApic() {
    return preferredApic;
  }

  public void setPreferredApic(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredApic preferredApic) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredHyperv preferredHyperv;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredHyperv getPreferredHyperv() {
    return preferredHyperv;
  }

  public void setPreferredHyperv(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredHyperv preferredHyperv) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredKvm preferredKvm;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredKvm getPreferredKvm() {
    return preferredKvm;
  }

  public void setPreferredKvm(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredKvm preferredKvm) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredPvspinlock preferredPvspinlock;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredPvspinlock getPreferredPvspinlock() {
    return preferredPvspinlock;
  }

  public void setPreferredPvspinlock(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredPvspinlock preferredPvspinlock) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredSmm preferredSmm;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredSmm getPreferredSmm() {
    return preferredSmm;
  }

  public void setPreferredSmm(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachinepreferencespec.features.PreferredSmm preferredSmm) {
