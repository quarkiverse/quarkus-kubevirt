...
public class Gpus implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.gpus.VirtualGPUOptions virtualGPUOptions;

  public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.gpus.VirtualGPUOptions getVirtualGPUOptions() {
    return virtualGPUOptions;
  }

  public void setVirtualGPUOptions(
      io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineinstancetypespec.gpus.VirtualGPUOptions virtualGPUOptions) {
