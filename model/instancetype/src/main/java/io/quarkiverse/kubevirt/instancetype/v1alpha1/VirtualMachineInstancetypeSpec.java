...
public class VirtualMachineInstancetypeSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.Cpu cpu;

    public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.Cpu getCpu() {
        return cpu;
    }

    public void setCpu(io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.Cpu cpu) {
        this.cpu = cpu;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.Gpus> gpus;

    public java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.Gpus> getGpus() {
        return gpus;
    }

    public void setGpus(
            java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.Gpus> gpus) {
        this.gpus = gpus;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.HostDevices> hostDevices;

    public java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.HostDevices> getHostDevices() {
        return hostDevices;
    }

    public void setHostDevices(
            java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.HostDevices> hostDevices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.LaunchSecurity launchSecurity;

    public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.LaunchSecurity getLaunchSecurity() {
        return launchSecurity;
    }

    public void setLaunchSecurity(
            io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.LaunchSecurity launchSecurity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.Memory memory;

    public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.Memory getMemory() {
        return memory;
    }

    public void setMemory(io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.Memory memory) {
        this.memory = memory;
    }
}
