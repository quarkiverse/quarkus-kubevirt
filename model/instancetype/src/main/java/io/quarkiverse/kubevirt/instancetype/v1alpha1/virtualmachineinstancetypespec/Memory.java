...
public class Memory implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.memory.Hugepages hugepages;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.memory.Hugepages getHugepages() {
    return hugepages;
  }

  public void setHugepages(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.memory.Hugepages hugepages) {
