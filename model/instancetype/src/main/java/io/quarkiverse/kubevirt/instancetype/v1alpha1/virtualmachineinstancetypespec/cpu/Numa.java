package io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu;
...
public class Numa implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.numa.GuestMappingPassthrough guestMappingPassthrough;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.numa.GuestMappingPassthrough getGuestMappingPassthrough() {
    return guestMappingPassthrough;
  }

  public void setGuestMappingPassthrough(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineinstancetypespec.cpu.numa.GuestMappingPassthrough guestMappingPassthrough) {
