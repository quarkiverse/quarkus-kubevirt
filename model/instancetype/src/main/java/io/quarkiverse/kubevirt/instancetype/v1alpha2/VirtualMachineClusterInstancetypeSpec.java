...
public class VirtualMachineClusterInstancetypeSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.Cpu cpu;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.Cpu getCpu() {
        return cpu;
    }

    public void setCpu(io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.Cpu cpu) {
        this.cpu = cpu;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.Gpus> gpus;

    public java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.Gpus> getGpus() {
        return gpus;
    }

    public void setGpus(
            java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.Gpus> gpus) {
        this.gpus = gpus;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.HostDevices> hostDevices;

    public java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.HostDevices> getHostDevices() {
        return hostDevices;
    }

    public void setHostDevices(
            java.util.List<io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.HostDevices> hostDevices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.LaunchSecurity launchSecurity;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.LaunchSecurity getLaunchSecurity() {
        return launchSecurity;
    }

    public void setLaunchSecurity(
            io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.LaunchSecurity launchSecurity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.Memory memory;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.Memory getMemory() {
        return memory;
    }

    public void setMemory(io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.Memory memory) {
        this.memory = memory;
    }
}
