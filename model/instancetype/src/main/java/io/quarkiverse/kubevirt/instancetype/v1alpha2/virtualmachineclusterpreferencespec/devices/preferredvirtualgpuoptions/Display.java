package io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.preferredvirtualgpuoptions;
...
public class Display implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.preferredvirtualgpuoptions.display.RamFB ramFB;

  public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.preferredvirtualgpuoptions.display.RamFB getRamFB() {
    return ramFB;
  }

  public void setRamFB(
      io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterpreferencespec.devices.preferredvirtualgpuoptions.display.RamFB ramFB) {
    this.ramFB = ramFB;
  }
}
