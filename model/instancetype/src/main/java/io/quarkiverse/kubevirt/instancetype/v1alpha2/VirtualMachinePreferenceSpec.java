...
public class VirtualMachinePreferenceSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Clock clock;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Clock getClock() {
        return clock;
    }

    public void setClock(io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Clock clock) {
        this.clock = clock;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Cpu cpu;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Cpu getCpu() {
        return cpu;
    }

    public void setCpu(io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Cpu cpu) {
        this.cpu = cpu;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Devices devices;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Devices getDevices() {
        return devices;
    }

    public void setDevices(io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Devices devices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Features features;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Features getFeatures() {
        return features;
    }

    public void setFeatures(io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Features features) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Firmware firmware;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Firmware getFirmware() {
        return firmware;
    }

    public void setFirmware(io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Firmware firmware) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Machine machine;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Machine getMachine() {
        return machine;
    }

    public void setMachine(io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Machine machine) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Volumes volumes;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Volumes getVolumes() {
        return volumes;
    }

    public void setVolumes(io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachinepreferencespec.Volumes volumes) {
