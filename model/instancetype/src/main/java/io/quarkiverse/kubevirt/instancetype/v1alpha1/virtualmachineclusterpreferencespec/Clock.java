...
public class Clock implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredClockOffset preferredClockOffset;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredClockOffset getPreferredClockOffset() {
    return preferredClockOffset;
  }

  public void setPreferredClockOffset(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredClockOffset preferredClockOffset) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredTimer preferredTimer;

  public io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredTimer getPreferredTimer() {
    return preferredTimer;
  }

  public void setPreferredTimer(
      io.quarkiverse.kubevirt.instancetype.v1alpha1.virtualmachineclusterpreferencespec.clock.PreferredTimer preferredTimer) {
