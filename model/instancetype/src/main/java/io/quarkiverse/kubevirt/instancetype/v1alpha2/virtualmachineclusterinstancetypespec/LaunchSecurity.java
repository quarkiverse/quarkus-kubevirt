...
public class LaunchSecurity implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.launchsecurity.Sev sev;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.launchsecurity.Sev getSev() {
        return sev;
    }

    public void setSev(
            io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.launchsecurity.Sev sev) {
        this.sev = sev;
    }
}
