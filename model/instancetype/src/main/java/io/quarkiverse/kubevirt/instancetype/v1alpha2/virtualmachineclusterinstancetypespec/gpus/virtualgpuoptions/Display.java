package io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.gpus.virtualgpuoptions;
...
public class Display implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.gpus.virtualgpuoptions.display.RamFB ramFB;

    public io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.gpus.virtualgpuoptions.display.RamFB getRamFB() {
        return ramFB;
    }

    public void setRamFB(
            io.quarkiverse.kubevirt.instancetype.v1alpha2.virtualmachineclusterinstancetypespec.gpus.virtualgpuoptions.display.RamFB ramFB) {
        this.ramFB = ramFB;
    }
}
