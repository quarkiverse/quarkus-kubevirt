...
public class WebhookConfiguration implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.webhookconfiguration.RestClient restClient;

  public io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.webhookconfiguration.RestClient getRestClient() {
    return restClient;
  }

  public void setRestClient(
      io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.webhookconfiguration.RestClient restClient) {
