package io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.readinessprobe;
...
public class HttpGet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.readinessprobe.httpget.HttpHeaders> httpHeaders;

    public java.util.List<io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.readinessprobe.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(
            java.util.List<io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.readinessprobe.httpget.HttpHeaders> httpHeaders) {
