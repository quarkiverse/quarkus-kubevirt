...
public class Gpus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.domain.devices.gpus.VirtualGPUOptions virtualGPUOptions;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.domain.devices.gpus.VirtualGPUOptions getVirtualGPUOptions() {
        return virtualGPUOptions;
    }

    public void setVirtualGPUOptions(
            io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.domain.devices.gpus.VirtualGPUOptions virtualGPUOptions) {
