package io.quarkiverse.kubevirt.v1.kubevirtspec.workloads;
...
public class NodePlacement implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.kubevirtspec.workloads.nodeplacement.Affinity affinity;

    public io.quarkiverse.kubevirt.v1.kubevirtspec.workloads.nodeplacement.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(io.quarkiverse.kubevirt.v1.kubevirtspec.workloads.nodeplacement.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.v1.kubevirtspec.workloads.nodeplacement.Tolerations> tolerations;

    public java.util.List<io.quarkiverse.kubevirt.v1.kubevirtspec.workloads.nodeplacement.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(
            java.util.List<io.quarkiverse.kubevirt.v1.kubevirtspec.workloads.nodeplacement.Tolerations> tolerations) {
