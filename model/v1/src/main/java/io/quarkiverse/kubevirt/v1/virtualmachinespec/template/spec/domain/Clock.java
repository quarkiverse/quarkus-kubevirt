...
public class Clock implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.clock.Timer timer;

  public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.clock.Timer getTimer() {
    return timer;
  }

  public void setTimer(io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.clock.Timer timer) {
    this.timer = timer;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.clock.Utc utc;

  public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.clock.Utc getUtc() {
    return utc;
  }

  public void setUtc(io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.clock.Utc utc) {
    this.utc = utc;
  }
