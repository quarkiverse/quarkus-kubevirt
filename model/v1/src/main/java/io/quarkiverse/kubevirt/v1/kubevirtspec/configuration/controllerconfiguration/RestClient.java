package io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.controllerconfiguration;
...
public class RestClient implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.controllerconfiguration.restclient.RateLimiter rateLimiter;

    public io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.controllerconfiguration.restclient.RateLimiter getRateLimiter() {
        return rateLimiter;
    }

    public void setRateLimiter(
            io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.controllerconfiguration.restclient.RateLimiter rateLimiter) {
