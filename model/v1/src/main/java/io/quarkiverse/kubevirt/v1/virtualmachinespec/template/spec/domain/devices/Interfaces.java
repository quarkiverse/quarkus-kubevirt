package io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices;
...
public class Interfaces implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Bridge bridge;

    public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Bridge getBridge() {
        return bridge;
    }

    public void setBridge(io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Bridge bridge) {
        this.bridge = bridge;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.DhcpOptions dhcpOptions;

    public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.DhcpOptions getDhcpOptions() {
        return dhcpOptions;
    }

    public void setDhcpOptions(
            io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.DhcpOptions dhcpOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Macvtap macvtap;

    public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Macvtap getMacvtap() {
        return macvtap;
    }

    public void setMacvtap(
            io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Macvtap macvtap) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Masquerade masquerade;

    public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Masquerade getMasquerade() {
        return masquerade;
    }

    public void setMasquerade(
            io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Masquerade masquerade) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Passt passt;

    public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Passt getPasst() {
        return passt;
    }

    public void setPasst(io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Passt passt) {
        this.passt = passt;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Ports> ports;

    public java.util.List<io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Ports> getPorts() {
        return ports;
    }

    public void setPorts(
            java.util.List<io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Ports> ports) {
        this.ports = ports;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Slirp slirp;

    public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Slirp getSlirp() {
        return slirp;
    }

    public void setSlirp(io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Slirp slirp) {
        this.slirp = slirp;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Sriov sriov;

    public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Sriov getSriov() {
        return sriov;
    }

    public void setSriov(io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.domain.devices.interfaces.Sriov sriov) {
        this.sriov = sriov;
    }
