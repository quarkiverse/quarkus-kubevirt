package io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.spec.pvc;
...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.spec.pvc.selector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.spec.pvc.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.spec.pvc.selector.MatchExpressions> matchExpressions) {
