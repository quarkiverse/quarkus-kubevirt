...
public class VirtualMachineInstancePresetSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.Domain domain;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.Domain getDomain() {
        return domain;
    }

    public void setDomain(io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.Domain domain) {
        this.domain = domain;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.Selector selector;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.Selector getSelector() {
        return selector;
    }

    public void setSelector(io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.Selector selector) {
