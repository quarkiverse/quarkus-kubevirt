package io.quarkiverse.kubevirt.v1.virtualmachinespec;
...
public class DataVolumeTemplates implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.Metadata metadata;

  public io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.Metadata getMetadata() {
    return metadata;
  }

  public void setMetadata(io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.Metadata metadata) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.Spec spec;

  public io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.Spec getSpec() {
    return spec;
  }

  public void setSpec(io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.Spec spec) {
    this.spec = spec;
  }
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
  @io.fabric8.generator.annotation.Nullable()
  private io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.Status status;

  public io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.Status getStatus() {
    return status;
  }

  public void setStatus(io.quarkiverse.kubevirt.v1.virtualmachinespec.datavolumetemplates.Status status) {
    this.status = status;
  }
