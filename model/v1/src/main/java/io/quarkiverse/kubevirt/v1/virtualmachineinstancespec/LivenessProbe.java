...
public class LivenessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.Exec exec;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.GuestAgentPing guestAgentPing;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.GuestAgentPing getGuestAgentPing() {
        return guestAgentPing;
    }

    public void setGuestAgentPing(
            io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.GuestAgentPing guestAgentPing) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.HttpGet httpGet;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.TcpSocket tcpSocket;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.livenessprobe.TcpSocket tcpSocket) {
