...
public class Numa implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.domain.cpu.numa.GuestMappingPassthrough guestMappingPassthrough;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.domain.cpu.numa.GuestMappingPassthrough getGuestMappingPassthrough() {
        return guestMappingPassthrough;
    }

    public void setGuestMappingPassthrough(
            io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.domain.cpu.numa.GuestMappingPassthrough guestMappingPassthrough) {
