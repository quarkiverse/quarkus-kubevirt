package io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.apiconfiguration;
...
public class RestClient implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.apiconfiguration.restclient.RateLimiter rateLimiter;

    public io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.apiconfiguration.restclient.RateLimiter getRateLimiter() {
        return rateLimiter;
    }

    public void setRateLimiter(
            io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.apiconfiguration.restclient.RateLimiter rateLimiter) {
