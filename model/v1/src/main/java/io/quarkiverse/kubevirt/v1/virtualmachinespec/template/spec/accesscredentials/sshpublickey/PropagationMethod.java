package io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.sshpublickey;
...
public class PropagationMethod implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.sshpublickey.propagationmethod.ConfigDrive configDrive;

  public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.sshpublickey.propagationmethod.ConfigDrive getConfigDrive() {
    return configDrive;
  }

  public void setConfigDrive(
      io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.sshpublickey.propagationmethod.ConfigDrive configDrive) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.sshpublickey.propagationmethod.QemuGuestAgent qemuGuestAgent;

  public io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.sshpublickey.propagationmethod.QemuGuestAgent getQemuGuestAgent() {
    return qemuGuestAgent;
  }

  public void setQemuGuestAgent(
      io.quarkiverse.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.sshpublickey.propagationmethod.QemuGuestAgent qemuGuestAgent) {
