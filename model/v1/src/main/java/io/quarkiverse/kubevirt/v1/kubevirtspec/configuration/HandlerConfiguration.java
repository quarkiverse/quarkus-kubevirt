...
public class HandlerConfiguration implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.RestClient restClient;

    public io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.RestClient getRestClient() {
        return restClient;
    }

    public void setRestClient(
            io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.RestClient restClient) {
