...
public class Synictimer implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.domain.features.hyperv.synictimer.Direct direct;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.domain.features.hyperv.synictimer.Direct getDirect() {
        return direct;
    }

    public void setDirect(
            io.quarkiverse.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.domain.features.hyperv.synictimer.Direct direct) {
        this.direct = direct;
    }
