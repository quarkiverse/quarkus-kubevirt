package io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.webhookconfiguration;
...
public class RestClient implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.webhookconfiguration.restclient.RateLimiter rateLimiter;

  public io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.webhookconfiguration.restclient.RateLimiter getRateLimiter() {
    return rateLimiter;
  }

  public void setRateLimiter(
      io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.webhookconfiguration.restclient.RateLimiter rateLimiter) {
