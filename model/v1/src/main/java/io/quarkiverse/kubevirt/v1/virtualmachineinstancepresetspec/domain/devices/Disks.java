...
public class Disks implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.BlockSize blockSize;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.BlockSize getBlockSize() {
        return blockSize;
    }

    public void setBlockSize(
            io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.BlockSize blockSize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.Cdrom cdrom;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.Cdrom getCdrom() {
        return cdrom;
    }

    public void setCdrom(io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.Cdrom cdrom) {
        this.cdrom = cdrom;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.Disk disk;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.Disk getDisk() {
        return disk;
    }

    public void setDisk(io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.Disk disk) {
        this.disk = disk;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.Lun lun;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.Lun getLun() {
        return lun;
    }

    public void setLun(io.quarkiverse.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.disks.Lun lun) {
        this.lun = lun;
    }
