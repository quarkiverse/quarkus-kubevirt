...
public class CloudInitNoCloud implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.volumes.cloudinitnocloud.NetworkDataSecretRef networkDataSecretRef;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.volumes.cloudinitnocloud.NetworkDataSecretRef getNetworkDataSecretRef() {
        return networkDataSecretRef;
    }

    public void setNetworkDataSecretRef(
            io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.volumes.cloudinitnocloud.NetworkDataSecretRef networkDataSecretRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.volumes.cloudinitnocloud.SecretRef secretRef;

    public io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.volumes.cloudinitnocloud.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(
            io.quarkiverse.kubevirt.v1.virtualmachineinstancespec.volumes.cloudinitnocloud.SecretRef secretRef) {
