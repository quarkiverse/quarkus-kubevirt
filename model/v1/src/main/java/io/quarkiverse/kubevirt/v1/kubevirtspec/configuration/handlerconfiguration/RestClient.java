package io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration;
...
public class RestClient implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.restclient.RateLimiter rateLimiter;

    public io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.restclient.RateLimiter getRateLimiter() {
        return rateLimiter;
    }

    public void setRateLimiter(
            io.quarkiverse.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.restclient.RateLimiter rateLimiter) {
