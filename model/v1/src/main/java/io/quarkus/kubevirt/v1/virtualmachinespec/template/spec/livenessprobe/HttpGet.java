package io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.livenessprobe;
...
public class HttpGet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.livenessprobe.httpget.HttpHeaders> httpHeaders;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.livenessprobe.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(
            java.util.List<io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.livenessprobe.httpget.HttpHeaders> httpHeaders) {
