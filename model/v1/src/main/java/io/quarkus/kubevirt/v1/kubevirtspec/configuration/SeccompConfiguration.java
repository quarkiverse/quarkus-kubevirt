...
public class SeccompConfiguration implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.kubevirtspec.configuration.seccompconfiguration.VirtualMachineInstanceProfile virtualMachineInstanceProfile;

    public io.quarkus.kubevirt.v1.kubevirtspec.configuration.seccompconfiguration.VirtualMachineInstanceProfile getVirtualMachineInstanceProfile() {
        return virtualMachineInstanceProfile;
    }

    public void setVirtualMachineInstanceProfile(
            io.quarkus.kubevirt.v1.kubevirtspec.configuration.seccompconfiguration.VirtualMachineInstanceProfile virtualMachineInstanceProfile) {
