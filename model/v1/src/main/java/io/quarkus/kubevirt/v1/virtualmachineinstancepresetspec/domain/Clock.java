...
public class Clock implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.clock.Timer timer;

    public io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.clock.Timer getTimer() {
        return timer;
    }

    public void setTimer(io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.clock.Timer timer) {
        this.timer = timer;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.clock.Utc utc;

    public io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.clock.Utc getUtc() {
        return utc;
    }

    public void setUtc(io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.clock.Utc utc) {
        this.utc = utc;
    }
}
