...
public class Memory implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.memory.Hugepages hugepages;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.memory.Hugepages getHugepages() {
        return hugepages;
    }

    public void setHugepages(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.memory.Hugepages hugepages) {
