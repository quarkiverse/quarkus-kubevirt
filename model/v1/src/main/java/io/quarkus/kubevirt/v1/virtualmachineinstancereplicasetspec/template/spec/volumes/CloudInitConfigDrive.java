package io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes;
...
public class CloudInitConfigDrive implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes.cloudinitconfigdrive.NetworkDataSecretRef networkDataSecretRef;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes.cloudinitconfigdrive.NetworkDataSecretRef getNetworkDataSecretRef() {
        return networkDataSecretRef;
    }

    public void setNetworkDataSecretRef(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes.cloudinitconfigdrive.NetworkDataSecretRef networkDataSecretRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes.cloudinitconfigdrive.SecretRef secretRef;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes.cloudinitconfigdrive.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes.cloudinitconfigdrive.SecretRef secretRef) {
