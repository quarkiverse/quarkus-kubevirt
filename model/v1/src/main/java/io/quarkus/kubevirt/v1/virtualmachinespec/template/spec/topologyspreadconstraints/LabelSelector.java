package io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.topologyspreadconstraints;
...
public class LabelSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.topologyspreadconstraints.labelselector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.topologyspreadconstraints.labelselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.topologyspreadconstraints.labelselector.MatchExpressions> matchExpressions) {
