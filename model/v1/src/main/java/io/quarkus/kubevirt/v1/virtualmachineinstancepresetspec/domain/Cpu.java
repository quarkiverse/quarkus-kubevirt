...
public class Cpu implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.cpu.Features> features;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.cpu.Features> getFeatures() {
        return features;
    }

    public void setFeatures(
            java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.cpu.Features> features) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.cpu.Numa numa;

    public io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.cpu.Numa getNuma() {
        return numa;
    }

    public void setNuma(io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.cpu.Numa numa) {
        this.numa = numa;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.cpu.Realtime realtime;

    public io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.cpu.Realtime getRealtime() {
        return realtime;
    }

    public void setRealtime(io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.cpu.Realtime realtime) {
