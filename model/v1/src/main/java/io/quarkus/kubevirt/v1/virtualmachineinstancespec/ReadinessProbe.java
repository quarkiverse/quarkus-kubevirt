...
public class ReadinessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.Exec exec;

    public io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.GuestAgentPing guestAgentPing;

    public io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.GuestAgentPing getGuestAgentPing() {
        return guestAgentPing;
    }

    public void setGuestAgentPing(
            io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.GuestAgentPing guestAgentPing) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.HttpGet httpGet;

    public io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.TcpSocket tcpSocket;

    public io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(io.quarkus.kubevirt.v1.virtualmachineinstancespec.readinessprobe.TcpSocket tcpSocket) {
