...
public class Ephemeral implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes.ephemeral.PersistentVolumeClaim persistentVolumeClaim;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes.ephemeral.PersistentVolumeClaim getPersistentVolumeClaim() {
        return persistentVolumeClaim;
    }

    public void setPersistentVolumeClaim(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.volumes.ephemeral.PersistentVolumeClaim persistentVolumeClaim) {
