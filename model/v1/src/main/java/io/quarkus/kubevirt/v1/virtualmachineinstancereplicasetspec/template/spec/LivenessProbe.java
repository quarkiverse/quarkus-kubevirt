...
public class LivenessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.Exec exec;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.GuestAgentPing guestAgentPing;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.GuestAgentPing getGuestAgentPing() {
        return guestAgentPing;
    }

    public void setGuestAgentPing(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.GuestAgentPing guestAgentPing) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.HttpGet httpGet;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.TcpSocket tcpSocket;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.livenessprobe.TcpSocket tcpSocket) {
