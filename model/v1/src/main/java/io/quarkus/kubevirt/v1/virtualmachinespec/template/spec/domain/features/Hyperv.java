package io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features;
...
public class Hyperv implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Evmcs evmcs;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Evmcs getEvmcs() {
        return evmcs;
    }

    public void setEvmcs(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Evmcs evmcs) {
        this.evmcs = evmcs;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Frequencies frequencies;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Frequencies getFrequencies() {
        return frequencies;
    }

    public void setFrequencies(
            io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Frequencies frequencies) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Ipi ipi;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Ipi getIpi() {
        return ipi;
    }

    public void setIpi(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Ipi ipi) {
        this.ipi = ipi;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Reenlightenment reenlightenment;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Reenlightenment getReenlightenment() {
        return reenlightenment;
    }

    public void setReenlightenment(
            io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Reenlightenment reenlightenment) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Relaxed relaxed;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Relaxed getRelaxed() {
        return relaxed;
    }

    public void setRelaxed(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Relaxed relaxed) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Reset reset;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Reset getReset() {
        return reset;
    }

    public void setReset(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Reset reset) {
        this.reset = reset;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Runtime runtime;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Runtime getRuntime() {
        return runtime;
    }

    public void setRuntime(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Runtime runtime) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Spinlocks spinlocks;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Spinlocks getSpinlocks() {
        return spinlocks;
    }

    public void setSpinlocks(
            io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Spinlocks spinlocks) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Synic synic;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Synic getSynic() {
        return synic;
    }

    public void setSynic(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Synic synic) {
        this.synic = synic;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Synictimer synictimer;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Synictimer getSynictimer() {
        return synictimer;
    }

    public void setSynictimer(
            io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Synictimer synictimer) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Tlbflush tlbflush;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Tlbflush getTlbflush() {
        return tlbflush;
    }

    public void setTlbflush(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Tlbflush tlbflush) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Vapic vapic;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Vapic getVapic() {
        return vapic;
    }

    public void setVapic(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Vapic vapic) {
        this.vapic = vapic;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Vendorid vendorid;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Vendorid getVendorid() {
        return vendorid;
    }

    public void setVendorid(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Vendorid vendorid) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Vpindex vpindex;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Vpindex getVpindex() {
        return vpindex;
    }

    public void setVpindex(io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.domain.features.hyperv.Vpindex vpindex) {
