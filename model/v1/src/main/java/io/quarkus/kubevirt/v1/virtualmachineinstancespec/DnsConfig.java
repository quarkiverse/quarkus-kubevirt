...
public class DnsConfig implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancespec.dnsconfig.Options> options;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancespec.dnsconfig.Options> getOptions() {
        return options;
    }

    public void setOptions(java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancespec.dnsconfig.Options> options) {
