...
public class HandlerConfiguration implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.RestClient restClient;

    public io.quarkus.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.RestClient getRestClient() {
        return restClient;
    }

    public void setRestClient(io.quarkus.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.RestClient restClient) {
