...
public class AccessCredentials implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.SshPublicKey sshPublicKey;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.SshPublicKey getSshPublicKey() {
        return sshPublicKey;
    }

    public void setSshPublicKey(
            io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.SshPublicKey sshPublicKey) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.UserPassword userPassword;

    public io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.UserPassword getUserPassword() {
        return userPassword;
    }

    public void setUserPassword(
            io.quarkus.kubevirt.v1.virtualmachinespec.template.spec.accesscredentials.UserPassword userPassword) {
