...
public class KubeVirtSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.kubevirtspec.CertificateRotateStrategy certificateRotateStrategy;

    public io.quarkus.kubevirt.v1.kubevirtspec.CertificateRotateStrategy getCertificateRotateStrategy() {
        return certificateRotateStrategy;
    }

    public void setCertificateRotateStrategy(
            io.quarkus.kubevirt.v1.kubevirtspec.CertificateRotateStrategy certificateRotateStrategy) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.kubevirtspec.Configuration configuration;

    public io.quarkus.kubevirt.v1.kubevirtspec.Configuration getConfiguration() {
        return configuration;
    }

    public void setConfiguration(io.quarkus.kubevirt.v1.kubevirtspec.Configuration configuration) {
        this.configuration = configuration;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("customizeComponents")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.kubevirtspec.CustomizeComponents customizeComponents;

    public io.quarkus.kubevirt.v1.kubevirtspec.CustomizeComponents getCustomizeComponents() {
        return customizeComponents;
    }

    public void setCustomizeComponents(io.quarkus.kubevirt.v1.kubevirtspec.CustomizeComponents customizeComponents) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1.kubevirtspec.ImagePullSecrets> imagePullSecrets;

    public java.util.List<io.quarkus.kubevirt.v1.kubevirtspec.ImagePullSecrets> getImagePullSecrets() {
        return imagePullSecrets;
    }

    public void setImagePullSecrets(java.util.List<io.quarkus.kubevirt.v1.kubevirtspec.ImagePullSecrets> imagePullSecrets) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.kubevirtspec.Infra infra;

    public io.quarkus.kubevirt.v1.kubevirtspec.Infra getInfra() {
        return infra;
    }

    public void setInfra(io.quarkus.kubevirt.v1.kubevirtspec.Infra infra) {
        this.infra = infra;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.kubevirtspec.WorkloadUpdateStrategy workloadUpdateStrategy;

    public io.quarkus.kubevirt.v1.kubevirtspec.WorkloadUpdateStrategy getWorkloadUpdateStrategy() {
        return workloadUpdateStrategy;
    }

    public void setWorkloadUpdateStrategy(io.quarkus.kubevirt.v1.kubevirtspec.WorkloadUpdateStrategy workloadUpdateStrategy) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.kubevirtspec.Workloads workloads;

    public io.quarkus.kubevirt.v1.kubevirtspec.Workloads getWorkloads() {
        return workloads;
    }

    public void setWorkloads(io.quarkus.kubevirt.v1.kubevirtspec.Workloads workloads) {
