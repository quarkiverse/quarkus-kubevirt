...
public class Affinity implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.affinity.NodeAffinity nodeAffinity;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.affinity.NodeAffinity getNodeAffinity() {
        return nodeAffinity;
    }

    public void setNodeAffinity(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.affinity.NodeAffinity nodeAffinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.affinity.PodAffinity podAffinity;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.affinity.PodAffinity getPodAffinity() {
        return podAffinity;
    }

    public void setPodAffinity(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.affinity.PodAffinity podAffinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.affinity.PodAntiAffinity podAntiAffinity;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.affinity.PodAntiAffinity getPodAntiAffinity() {
        return podAntiAffinity;
    }

    public void setPodAntiAffinity(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.affinity.PodAntiAffinity podAntiAffinity) {
