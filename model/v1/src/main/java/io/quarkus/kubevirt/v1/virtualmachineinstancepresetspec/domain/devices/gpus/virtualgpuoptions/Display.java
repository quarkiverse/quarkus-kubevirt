package io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.gpus.virtualgpuoptions;
...
public class Display implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.gpus.virtualgpuoptions.display.RamFB ramFB;

    public io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.gpus.virtualgpuoptions.display.RamFB getRamFB() {
        return ramFB;
    }

    public void setRamFB(
            io.quarkus.kubevirt.v1.virtualmachineinstancepresetspec.domain.devices.gpus.virtualgpuoptions.display.RamFB ramFB) {
        this.ramFB = ramFB;
    }
}
