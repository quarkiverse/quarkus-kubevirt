package io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests;
...
public class AddVolumeOptions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.addvolumeoptions.Disk disk;

    public io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.addvolumeoptions.Disk getDisk() {
        return disk;
    }

    public void setDisk(io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.addvolumeoptions.Disk disk) {
        this.disk = disk;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.addvolumeoptions.VolumeSource volumeSource;

    public io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.addvolumeoptions.VolumeSource getVolumeSource() {
        return volumeSource;
    }

    public void setVolumeSource(
            io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.addvolumeoptions.VolumeSource volumeSource) {
