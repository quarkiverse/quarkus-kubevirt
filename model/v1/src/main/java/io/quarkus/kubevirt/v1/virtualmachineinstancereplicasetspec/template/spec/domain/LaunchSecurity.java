...
public class LaunchSecurity implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.domain.launchsecurity.Sev sev;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.domain.launchsecurity.Sev getSev() {
        return sev;
    }

    public void setSev(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.domain.launchsecurity.Sev sev) {
        this.sev = sev;
    }
}
