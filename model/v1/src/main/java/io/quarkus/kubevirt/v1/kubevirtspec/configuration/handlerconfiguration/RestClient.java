package io.quarkus.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration;
...
public class RestClient implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.restclient.RateLimiter rateLimiter;

    public io.quarkus.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.restclient.RateLimiter getRateLimiter() {
        return rateLimiter;
    }

    public void setRateLimiter(
            io.quarkus.kubevirt.v1.kubevirtspec.configuration.handlerconfiguration.restclient.RateLimiter rateLimiter) {
