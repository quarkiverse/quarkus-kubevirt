package io.quarkus.kubevirt.v1.virtualmachinestatus;
...
public class VolumeRequests implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.AddVolumeOptions addVolumeOptions;

    public io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.AddVolumeOptions getAddVolumeOptions() {
        return addVolumeOptions;
    }

    public void setAddVolumeOptions(
            io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.AddVolumeOptions addVolumeOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.RemoveVolumeOptions removeVolumeOptions;

    public io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.RemoveVolumeOptions getRemoveVolumeOptions() {
        return removeVolumeOptions;
    }

    public void setRemoveVolumeOptions(
            io.quarkus.kubevirt.v1.virtualmachinestatus.volumerequests.RemoveVolumeOptions removeVolumeOptions) {
