...
public class VirtualMachineSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachinespec.DataVolumeTemplates> dataVolumeTemplates;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachinespec.DataVolumeTemplates> getDataVolumeTemplates() {
        return dataVolumeTemplates;
    }

    public void setDataVolumeTemplates(
            java.util.List<io.quarkus.kubevirt.v1.virtualmachinespec.DataVolumeTemplates> dataVolumeTemplates) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.Instancetype instancetype;

    public io.quarkus.kubevirt.v1.virtualmachinespec.Instancetype getInstancetype() {
        return instancetype;
    }

    public void setInstancetype(io.quarkus.kubevirt.v1.virtualmachinespec.Instancetype instancetype) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.Preference preference;

    public io.quarkus.kubevirt.v1.virtualmachinespec.Preference getPreference() {
        return preference;
    }

    public void setPreference(io.quarkus.kubevirt.v1.virtualmachinespec.Preference preference) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachinespec.Template template;

    public io.quarkus.kubevirt.v1.virtualmachinespec.Template getTemplate() {
        return template;
    }

    public void setTemplate(io.quarkus.kubevirt.v1.virtualmachinespec.Template template) {
