...
public class Disks implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.BlockSize blockSize;

    public io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.BlockSize getBlockSize() {
        return blockSize;
    }

    public void setBlockSize(io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.BlockSize blockSize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.Cdrom cdrom;

    public io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.Cdrom getCdrom() {
        return cdrom;
    }

    public void setCdrom(io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.Cdrom cdrom) {
        this.cdrom = cdrom;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.Disk disk;

    public io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.Disk getDisk() {
        return disk;
    }

    public void setDisk(io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.Disk disk) {
        this.disk = disk;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.Lun lun;

    public io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.Lun getLun() {
        return lun;
    }

    public void setLun(io.quarkus.kubevirt.v1.virtualmachineinstancespec.domain.devices.disks.Lun lun) {
        this.lun = lun;
    }
