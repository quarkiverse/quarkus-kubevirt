package io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.AccessCredentials> accessCredentials;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.AccessCredentials> getAccessCredentials() {
        return accessCredentials;
    }

    public void setAccessCredentials(
            java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.AccessCredentials> accessCredentials) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Affinity affinity;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.DnsConfig dnsConfig;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.DnsConfig getDnsConfig() {
        return dnsConfig;
    }

    public void setDnsConfig(io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.DnsConfig dnsConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Domain domain;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Domain getDomain() {
        return domain;
    }

    public void setDomain(io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Domain domain) {
        this.domain = domain;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.LivenessProbe livenessProbe;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.LivenessProbe getLivenessProbe() {
        return livenessProbe;
    }

    public void setLivenessProbe(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.LivenessProbe livenessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Networks> networks;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Networks> getNetworks() {
        return networks;
    }

    public void setNetworks(
            java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Networks> networks) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.ReadinessProbe readinessProbe;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.ReadinessProbe getReadinessProbe() {
        return readinessProbe;
    }

    public void setReadinessProbe(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.ReadinessProbe readinessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Tolerations> tolerations;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(
            java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Tolerations> tolerations) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.TopologySpreadConstraints> topologySpreadConstraints;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.TopologySpreadConstraints> getTopologySpreadConstraints() {
        return topologySpreadConstraints;
    }

    public void setTopologySpreadConstraints(
            java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.TopologySpreadConstraints> topologySpreadConstraints) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Volumes> volumes;

    public java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Volumes> getVolumes() {
        return volumes;
    }

    public void setVolumes(
            java.util.List<io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.Volumes> volumes) {
