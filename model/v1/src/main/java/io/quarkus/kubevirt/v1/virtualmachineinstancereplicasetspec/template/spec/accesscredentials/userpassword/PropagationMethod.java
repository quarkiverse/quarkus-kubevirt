package io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.userpassword;
...
public class PropagationMethod implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.userpassword.propagationmethod.QemuGuestAgent qemuGuestAgent;

    public io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.userpassword.propagationmethod.QemuGuestAgent getQemuGuestAgent() {
        return qemuGuestAgent;
    }

    public void setQemuGuestAgent(
            io.quarkus.kubevirt.v1.virtualmachineinstancereplicasetspec.template.spec.accesscredentials.userpassword.propagationmethod.QemuGuestAgent qemuGuestAgent) {
