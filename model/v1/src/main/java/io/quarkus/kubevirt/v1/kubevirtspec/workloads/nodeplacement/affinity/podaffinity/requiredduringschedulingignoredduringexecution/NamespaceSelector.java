package io.quarkus.kubevirt.v1.kubevirtspec.workloads.nodeplacement.affinity.podaffinity.requiredduringschedulingignoredduringexecution;
...
public class NamespaceSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.v1.kubevirtspec.workloads.nodeplacement.affinity.podaffinity.requiredduringschedulingignoredduringexecution.namespaceselector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkus.kubevirt.v1.kubevirtspec.workloads.nodeplacement.affinity.podaffinity.requiredduringschedulingignoredduringexecution.namespaceselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkus.kubevirt.v1.kubevirtspec.workloads.nodeplacement.affinity.podaffinity.requiredduringschedulingignoredduringexecution.namespaceselector.MatchExpressions> matchExpressions) {
