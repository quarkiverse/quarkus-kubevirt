...
public class External implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.external.Manifests> manifests;

    public java.util.List<io.quarkiverse.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.external.Manifests> getManifests() {
        return manifests;
    }

    public void setManifests(
            java.util.List<io.quarkiverse.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.external.Manifests> manifests) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.external.Volumes> volumes;

    public java.util.List<io.quarkiverse.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.external.Volumes> getVolumes() {
        return volumes;
    }

    public void setVolumes(
            java.util.List<io.quarkiverse.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.external.Volumes> volumes) {
