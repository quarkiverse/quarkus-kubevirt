package io.quarkus.kubevirt.export.v1alpha1;
...
public class VirtualMachineExportStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(
            java.util.List<io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.Conditions> conditions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.Links links;

    public io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.Links getLinks() {
        return links;
    }

    public void setLinks(io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.Links links) {
        this.links = links;
    }
