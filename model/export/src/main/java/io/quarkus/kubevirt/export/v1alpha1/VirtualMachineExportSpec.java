...
public class VirtualMachineExportSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportspec.Source source;

    public io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportspec.Source getSource() {
        return source;
    }

    public void setSource(io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportspec.Source source) {
        this.source = source;
    }
