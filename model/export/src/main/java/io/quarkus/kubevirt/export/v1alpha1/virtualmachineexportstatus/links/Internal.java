...
public class Internal implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.internal.Manifests> manifests;

    public java.util.List<io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.internal.Manifests> getManifests() {
        return manifests;
    }

    public void setManifests(
            java.util.List<io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.internal.Manifests> manifests) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.internal.Volumes> volumes;

    public java.util.List<io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.internal.Volumes> getVolumes() {
        return volumes;
    }

    public void setVolumes(
            java.util.List<io.quarkus.kubevirt.export.v1alpha1.virtualmachineexportstatus.links.internal.Volumes> volumes) {
