package io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.podantiaffinity;
...
public class RequiredDuringSchedulingIgnoredDuringExecution implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.LabelSelector labelSelector;

  public io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.LabelSelector getLabelSelector() {
    return labelSelector;
  }

  public void setLabelSelector(
      io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.LabelSelector labelSelector) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.NamespaceSelector namespaceSelector;

  public io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.NamespaceSelector getNamespaceSelector() {
    return namespaceSelector;
  }

  public void setNamespaceSelector(
      io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.podantiaffinity.requiredduringschedulingignoredduringexecution.NamespaceSelector namespaceSelector) {
