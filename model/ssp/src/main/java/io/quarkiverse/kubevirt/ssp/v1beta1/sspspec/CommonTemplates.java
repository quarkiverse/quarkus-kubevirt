...
public class CommonTemplates implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.commontemplates.DataImportCronTemplates> dataImportCronTemplates;

    public java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.commontemplates.DataImportCronTemplates> getDataImportCronTemplates() {
        return dataImportCronTemplates;
    }

    public void setDataImportCronTemplates(
            java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.commontemplates.DataImportCronTemplates> dataImportCronTemplates) {
