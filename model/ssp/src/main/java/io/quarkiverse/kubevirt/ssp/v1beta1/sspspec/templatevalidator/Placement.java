package io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator;
...
public class Placement implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.Affinity affinity;

    public io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.Tolerations> tolerations;

    public java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(
            java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.Tolerations> tolerations) {
