package io.quarkiverse.kubevirt.ssp.v1beta1;
...
public class SSPSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
  ...
  private io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.CommonInstancetypes commonInstancetypes;

  public io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.CommonInstancetypes getCommonInstancetypes() {
    return commonInstancetypes;
  }

  public void setCommonInstancetypes(io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.CommonInstancetypes commonInstancetypes) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.CommonTemplates commonTemplates;

  public io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.CommonTemplates getCommonTemplates() {
    return commonTemplates;
  }

  public void setCommonTemplates(io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.CommonTemplates commonTemplates) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.NodeLabeller nodeLabeller;

  public io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.NodeLabeller getNodeLabeller() {
    return nodeLabeller;
  }

  public void setNodeLabeller(io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.NodeLabeller nodeLabeller) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.TemplateValidator templateValidator;

  public io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.TemplateValidator getTemplateValidator() {
    return templateValidator;
  }

  public void setTemplateValidator(io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.TemplateValidator templateValidator) {
  ...
  @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
  private io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.TlsSecurityProfile tlsSecurityProfile;

  public io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.TlsSecurityProfile getTlsSecurityProfile() {
    return tlsSecurityProfile;
  }

  public void setTlsSecurityProfile(io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.TlsSecurityProfile tlsSecurityProfile) {
