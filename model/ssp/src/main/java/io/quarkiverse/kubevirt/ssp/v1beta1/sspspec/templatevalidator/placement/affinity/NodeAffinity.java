...
public class NodeAffinity implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution> preferredDuringSchedulingIgnoredDuringExecution;

    public java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution> getPreferredDuringSchedulingIgnoredDuringExecution() {
        return preferredDuringSchedulingIgnoredDuringExecution;
    }

    public void setPreferredDuringSchedulingIgnoredDuringExecution(
            java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution> preferredDuringSchedulingIgnoredDuringExecution) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.nodeaffinity.RequiredDuringSchedulingIgnoredDuringExecution requiredDuringSchedulingIgnoredDuringExecution;

    public io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.nodeaffinity.RequiredDuringSchedulingIgnoredDuringExecution getRequiredDuringSchedulingIgnoredDuringExecution() {
        return requiredDuringSchedulingIgnoredDuringExecution;
    }

    public void setRequiredDuringSchedulingIgnoredDuringExecution(
            io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.templatevalidator.placement.affinity.nodeaffinity.RequiredDuringSchedulingIgnoredDuringExecution requiredDuringSchedulingIgnoredDuringExecution) {
