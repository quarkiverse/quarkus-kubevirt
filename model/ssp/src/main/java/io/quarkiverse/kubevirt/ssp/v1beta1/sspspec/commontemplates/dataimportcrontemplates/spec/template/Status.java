...
public class Status implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.status.Conditions> conditions;

    public java.util.List<io.quarkiverse.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.status.Conditions> getConditions() {
        return conditions;
    }
