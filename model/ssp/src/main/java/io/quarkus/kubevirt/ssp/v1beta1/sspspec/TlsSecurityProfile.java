...
public class TlsSecurityProfile implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Custom custom;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Custom getCustom() {
        return custom;
    }

    public void setCustom(io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Custom custom) {
        this.custom = custom;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Intermediate intermediate;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Intermediate getIntermediate() {
        return intermediate;
    }

    public void setIntermediate(io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Intermediate intermediate) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Modern modern;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Modern getModern() {
        return modern;
    }

    public void setModern(io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Modern modern) {
        this.modern = modern;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Old old;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Old getOld() {
        return old;
    }

    public void setOld(io.quarkus.kubevirt.ssp.v1beta1.sspspec.tlssecurityprofile.Old old) {
        this.old = old;
    }
