...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Checkpoints> checkpoints;

    public java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Checkpoints> getCheckpoints() {
        return checkpoints;
    }

    public void setCheckpoints(
            java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Checkpoints> checkpoints) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Pvc pvc;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Pvc getPvc() {
        return pvc;
    }

    public void setPvc(
            io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Pvc pvc) {
        this.pvc = pvc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Source source;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Source getSource() {
        return source;
    }

    public void setSource(
            io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Source source) {
        this.source = source;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.SourceRef sourceRef;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.SourceRef getSourceRef() {
        return sourceRef;
    }

    public void setSourceRef(
            io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.SourceRef sourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Storage storage;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Storage getStorage() {
        return storage;
    }

    public void setStorage(
            io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.template.spec.Storage storage) {
