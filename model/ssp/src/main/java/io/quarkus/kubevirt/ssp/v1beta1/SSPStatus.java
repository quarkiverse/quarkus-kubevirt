...
public class SSPStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspstatus.Conditions> conditions;

    public java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspstatus.Conditions> conditions) {
