package io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm;
...
public class NamespaceSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions> matchExpressions;

    public java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
            java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions> matchExpressions) {
