package io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.Template template;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.Template getTemplate() {
        return template;
    }

    public void setTemplate(
            io.quarkus.kubevirt.ssp.v1beta1.sspspec.commontemplates.dataimportcrontemplates.spec.Template template) {
