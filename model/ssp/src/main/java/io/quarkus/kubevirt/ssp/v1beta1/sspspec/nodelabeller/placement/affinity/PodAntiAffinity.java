package io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity;
...
public class PodAntiAffinity implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.PreferredDuringSchedulingIgnoredDuringExecution> preferredDuringSchedulingIgnoredDuringExecution;

    public java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.PreferredDuringSchedulingIgnoredDuringExecution> getPreferredDuringSchedulingIgnoredDuringExecution() {
        return preferredDuringSchedulingIgnoredDuringExecution;
    }

    public void setPreferredDuringSchedulingIgnoredDuringExecution(
            java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.PreferredDuringSchedulingIgnoredDuringExecution> preferredDuringSchedulingIgnoredDuringExecution) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.RequiredDuringSchedulingIgnoredDuringExecution> requiredDuringSchedulingIgnoredDuringExecution;

    public java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.RequiredDuringSchedulingIgnoredDuringExecution> getRequiredDuringSchedulingIgnoredDuringExecution() {
        return requiredDuringSchedulingIgnoredDuringExecution;
    }

    public void setRequiredDuringSchedulingIgnoredDuringExecution(
            java.util.List<io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.placement.affinity.podantiaffinity.RequiredDuringSchedulingIgnoredDuringExecution> requiredDuringSchedulingIgnoredDuringExecution) {
