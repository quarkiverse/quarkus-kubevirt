...
public class NodeLabeller implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.Placement placement;

    public io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.Placement getPlacement() {
        return placement;
    }

    public void setPlacement(io.quarkus.kubevirt.ssp.v1beta1.sspspec.nodelabeller.Placement placement) {
